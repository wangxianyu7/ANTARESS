...
def ANTARESS_settings(data_dic,mock_dic,gen_dic,theo_dic,plot_dic,glob_fit_dic,detrend_prof_dic,corr_spot_dic):
   ...
   #Transiting spots
    ...
    #%%%%% Spectral range(s) to be fitted
    #    - format: {inst : { vis : { [ [x1,x2] , [x3,x4] , [x5,x6] , ... ] } } } in the input data frame
    #      ranges will be automatically shifted to the star rest frame when relevant
  ...
  #Turn this on and look at the properties
   ...
   #  %%%% Master exposures
    ...
    if gen_dic['star_name']=='TRAPPIST1':    
        ...
        data_dic['Res']['idx_in_bin']={'NIRPS_HE':{'mockvis':list(np.arange(0, 7,dtype=int))+list(np.arange(23, 30,dtype=int))}} #c-transit high SNR
    ...
    #Zodiacs
    if gen_dic['star_name'] in ['Capricorn','Cancer','Gemini','Sagittarius','Leo','Aquarius','Aries','Libra','Taurus','Scorpio','Virgo','Pisces']:
        if gen_dic['star_name']=='Gemini':data_dic['Res']['idx_in_bin']={'ESPRESSO':{'mock_vis':list(np.arange(0, 41,dtype=int))+list(np.arange(139, 180,dtype=int))}} 
        elif gen_dic['star_name']=='Sagittarius':data_dic['Res']['idx_in_bin']={'ESPRESSO':{'mock_vis':list(np.arange(0, 47,dtype=int))+list(np.arange(133, 180,dtype=int))}} 
        else:data_dic['Res']['idx_in_bin']={'ESPRESSO':{'mock_vis':list(np.arange(0, 47,dtype=int))+list(np.arange(133, 180,dtype=int))}} 
    ...
    # if gen_dic['star_name'] in ['AU_Mic','AUMic','Capricorn','Cancer','Gemini','Sagittarius','Leo','Aquarius','Aries','Libra','Taurus','Scorpio','Virgo','Pisces']:
    #     glob_fit_dic['ResProf']['custom_init_walkers']=multivar_Gauss_walk
...
#            'plot1s_1D':False
    ...
    plot_dic['map_Res_prof_clean_sp_est']='png'
    plot_dic['map_Res_prof_clean_fa_est']='png'
    plot_dic['map_Res_prof_clean_pl_est']='png'   
    ...
    plot_dic['map_Res_prof_unclean_sp_est']='png'
    plot_dic['map_Res_prof_unclean_fa_est']='png'
    plot_dic['map_Res_prof_unclean_pl_est']='png'      

    #%%%%% 2D maps : differential profiles corrected for the impact of spots and faculae
    plot_dic['map_Res_corr_sp_fa']='png'
