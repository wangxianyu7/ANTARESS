...
if __name__ == '__main__':
    ...
    if gen_dic['star_name']=='WASP107':gen_dic['transit_pl']={'WASP107b':{'HARPS':['20140406','20180201','20180313'],'CARMENES_VIS':['20180224']}}    
    ...
    if gen_dic['star_name'] in ['HD209458','WASP76','HD189733']:gen_dic['use_cov']=True
    ...
    if gen_dic['star_name'] in ['HD189733','WASP43','L98_59','GJ1214']:gen_dic['calc_proc_data']=True
...
#   the model table table can be oversampled using the gen_dic['rv_osamp_line_mod'] field 
...
#    - format is {inst:{vis:[iexp] or 'all'}}
gen_dic['fibB_corr']={}
...
#----------------------------------------------
#%%% Continuum settings  
#    - continuum of disk-integrated stellar spectrum
#    - used in order normalization and persistent peak masking
#----------------------------------------------
...
if __name__ == '__main__':
    ...
    #Using fiber-B corrected data
    if 'GJ436_b' in gen_dic['transit_pl']:gen_dic['fibB_corr']=['ESPRESSO']
    ...
    if gen_dic['star_name'] in ['WASP76','HD209458']:gen_dic['contin_roll_win'] = {'ESPRESSO':2}  
        
    #Smoothing window
    gen_dic['contin_smooth_win']={'CARMENES_VIS':0.5}
    if gen_dic['star_name'] in ['WASP76','HD209458']:gen_dic['contin_smooth_win'] = {'ESPRESSO':0.3}  
    
    #Local maxima window
    gen_dic['contin_locmax_win']={'CARMENES_VIS':0.3}
    if gen_dic['star_name'] in ['WASP76','HD209458']:gen_dic['contin_locmax_win'] = {'ESPRESSO':0.1}  
    
    #Flux/wavelength stretching
    gen_dic['contin_stretch']={'CARMENES_VIS':10}    
    if gen_dic['star_name'] in ['WASP76','HD209458']:gen_dic['contin_stretch'] = {'ESPRESSO':15}  
    
    #Rolling pin radius
    gen_dic['contin_pinR']={'CARMENES_VIS':5}  
    if gen_dic['star_name'] in ['WASP76','HD209458']:gen_dic['contin_pinR'] = {'ESPRESSO':15}  
...
#    - applied to all CCFs calculated from spectra in the routine
...
#      otherwise select for each instrument the indices of the orders as an array
#    - HARPS: i=0 to 71
#      HARPN: i=0 to 68
#      SOPHIE: i=0 to 38  
#      ESPRESSO: i=0 to 169  
...
#%%%% Oversampling 
#    - for all line models in the pipeline
#    - in km/s (profiles in wavelength space are modelled in RV space and then converted) 
#    - can be relevant for profiles measured with low resolution
#    - set to None for no oversampling
gen_dic['rv_osamp_line_mod']=None


#%%%% Resolution    
#    - for theoretical models of CCFs (km/s)
#    - used for the post-processsing of fit results and plots
gen_dic['dRV_HR_mod']=0.1
gen_dic['RVstart_HR_mod']=-100.
gen_dic['RVend_HR_mod']=100.
...
if __name__ == '__main__':
    ...
    #Orders
    #gen_dic['order_range']={'HARPS':np.arange(36),'HARPN':np.arange(36)}
    #gen_dic['order_range']={'HARPS':[36,71],'HARPN':[36,68]}
    #gen_dic['order_range']={'HARPS':[45,71],'HARPN':[45,68]}
    #gen_dic['order_range']={'HARPN':range(35)}
    #gen_dic['order_range']={'HARPN':range(35,69)}
    #gen_dic['order_range']={'HARPS':range(45)}   #< 530 nm environ
    #gen_dic['order_range']={'HARPS':range(45,69)}
    #gen_dic['order_range']={'HARPN':range(20,40)}
#    gen_dic['order_range']={'ESPRESSO':[50]}    
    # if gen_dic['transit_pl']=='Nu2Lupi_c':
    #     gen_dic['order_range']={'ESPRESSO':range(90)}     #Blue detector   
    #     gen_dic['order_range']={'ESPRESSO':range(90,170)} #Red detector      
    # if gen_dic['transit_pl']=='55Cnc_e':
    #     gen_dic['order_range']={'ESPRESSO':range(43)}       
    #     gen_dic['order_range']={'ESPRESSO':range(43,85)}      
    #     gen_dic['order_range']={'ESPRESSO':range(85,128)}      
    #     gen_dic['order_range']={'ESPRESSO':range(129,170)}     
    #     gen_dic['order_range']={'ESPRESSO':range(85)}   
    #     gen_dic['order_range']={'ESPRESSO':range(91,170)} 
    #     gen_dic['order_range']={'ESPRESSO':range(0,1)} 
    #     # gen_dic['order_range']={'ESPRESSO':range(90,170)} 
    #     gen_dic['order_range']={'ESPRESSO':list(range(108,170))} 
    #     # gen_dic['order_range']={'ESPRESSO':range(108,170)} 
    #     # gen_dic['order_range']={'ESPRESSO':[168,169]} 

    # if gen_dic['transit_pl']=='HD3167_b':

    #     #Dispersed orders removed
    #     gen_dic['order_range']={'ESPRESSO':list(range(170))}  
    #     for islice in [86,87,90,91,92,93,94,95,96,97,98,99,100,101,104,105,106,107]:gen_dic['order_range']['ESPRESSO'].remove(islice)
        
    #     # #Dispersed orders removed + blue orders removed (final solution)
    #     # gen_dic['order_range']={'ESPRESSO':list(range(20,170))}  
    #     # for islice in [86,87,90,91,92,93,94,95,96,97,98,99,100,101,104,105,106,107]:gen_dic['order_range']['ESPRESSO'].remove(islice)
    ...
    #     gen_dic['order_range']={'HARPN':list(range(4,69))}  
    #     for islice in [43,44,47,48]:gen_dic['order_range']['HARPN'].remove(islice)      
    ...
    #Oversampling 
    # gen_dic['rv_osamp_line_mod']=0.5 #None  #1.
    # print('ATTENTION rv_osamp_line_mod')


    #Resolution    
    if gen_dic['star_name']=='GJ436':
        gen_dic['dRV_HR_mod']=0.008
        gen_dic['RVstart_HR_mod']=-60.
        gen_dic['RVend_HR_mod']=60.
    if gen_dic['star_name']=='MASCARA1':
        gen_dic['dRV_HR_mod']=0.1
        gen_dic['RVstart_HR_mod']=-150.
        gen_dic['RVend_HR_mod']=150.
    if gen_dic['star_name']=='GJ3090':
        gen_dic['dRV_HR_mod']=0.1
        gen_dic['RVstart_HR_mod']=-150.
        gen_dic['RVend_HR_mod']=150.
...
#    - for the broadening of analytical line profile models
...
if __name__ == '__main__':
    ...
    elif gen_dic['star_name']=='WASP107':theo_dic['nsub_Dpl']={'WASP107b':31.} 
...
##################################################################################################
#%% Modules: global spectral corrections
##################################################################################################
...
if __name__ == '__main__':
    ...
    if gen_dic['star_name'] in ['WASP76','HD209458']:gen_dic['corr_tell']=True  
    ...
    #Correction mode     
    if gen_dic['star_name'] in ['55Cnc','WASP76','HD209458']:gen_dic['calc_tell_mode']='autom'   
    
    #Telluric species
    if gen_dic['star_name'] in ['WASP76','HD209458']:gen_dic['tell_species']=['H2O','O2']  
...
if __name__ == '__main__':
    ...
    if gen_dic['star_name'] in ['WASP76','HD209458','WASP107','HAT_P11','WASP156','55Cnc','GJ3090','HD29291']:gen_dic['corr_Fbal']=True # &  False
    ...
    #Model
    if gen_dic['star_name'] in ['WASP76','HD209458','55Cnc']:
...
if __name__ == '__main__':
    ...
    # elif gen_dic['transit_pl']=='WASP121b':
    #     corr_line_prof_dic['prop']={'HARPS':{'31-12-17':{}}}  
    # elif gen_dic['transit_pl']=='KELT10b':
    #     corr_line_prof_dic['prop']={'HARPS':{'2016-07-21':{}}}
    ...
    if gen_dic['star_name']=='55Cnc':
        ...
        corr_line_prof_dic['prop']={'HARPN':{'20160318':{'ctrst_snr':np.array([3.210585e-01,1.304690e-04])},'20160411':{'ctrst_snr':np.array([3.208316e-01,1.543300e-04])}},
                              'HARPS':{'20070509':{'ctrst_snr':np.array([3.098972e-01,8.871225e-04])}}}  
    elif gen_dic['star_name']=='HD15337':        
        corr_line_prof_dic['prop']={'ESPRESSO_MR':{'20191122':{'ctrst_snr':np.array([5.597405e-01,2.065194e-04,-5.500241e-07]),
    ...
    #RM survey
        ...
        # corr_line_prof_dic['prop']={'HARPN':{'20200130':{'ctrst_snr':{'pol':np.array([None,1.268132e-04])},'FWHM_snr':{'pol':np.array([None,-1.731632e-04])}}}}    #new mask, no skycorr
        # corr_line_prof_dic['prop']={'HARPN':{'20200130':{'ctrst_snr':{'pol':np.array([None,1.372159e-04])}}}}    #kitcat mask, skycorr
        corr_line_prof_dic['prop']={'HARPN':{'20200130':{'RV_snr':{'pol':1e-3*np.array([7.768602e+00,-2.131915e-01])}}}}    #kitcat mask, no skycorr        

        
    elif gen_dic['star_name']=='Kepler68':    
        # corr_line_prof_dic['prop']={'HARPN':{'20190803':{'ctrst_snr':{'pol':np.array([None,2.403199e-03,-3.496778e-05])}}}}    #new mask
        # corr_line_prof_dic['prop']={'HARPN':{'20190803':{'ctrst_snr':{'pol':np.array([5.129138e-01,1.433217e-04])}}}}  
        corr_line_prof_dic['prop']={'HARPN':{'20190803':{'ctrst_snr':{'pol':np.array([None,2.693647e-03,-4.065767e-05])}}}}    #kitcat final
        

        
    elif gen_dic['star_name']=='HAT_P33':    
        # corr_line_prof_dic['prop']={'HARPN':{'20191204':{'ctrst_phase':{'pol':np.array([None,-1.010879e-01])}}}}    
        corr_line_prof_dic['prop']={'HARPN':{'20191204':{'ctrst_snr':{'pol':np.array([None,5.189697e-04])}}}}   #final
        ...
        # corr_line_prof_dic['prop']={'HARPN':{'20200202':{'ctrst_phase':{'pol':np.array([None,3.544506e-02])},'FWHM_phase':{'pol':np.array([None,-7.902347e-02])}}}}      #kitcat        
        corr_line_prof_dic['prop']={'HARPN':{'20200202':{'ctrst_snr':{'pol':np.array([None,-4.354953e-05])},'FWHM_snr':{'pol':np.array([None,1.030280e-04])}}}}      #kitcat, final

    elif gen_dic['star_name']=='HAT_P49':
        # corr_line_prof_dic['prop']={'HARPN':{'20200730':{'ctrst_phase':{'pol':np.array([None,-1.146138e-01])},'FWHM_phase':{'pol':np.array([None,1.019980e-01])},'RV_phase':{'pol':1e-3*np.array([-2.046618e+01,-9.318635e+02])}}}}    #new        
        corr_line_prof_dic['prop']={'HARPN':{'20200730':{
        ...
        # #Fit_noTexp2_post111
        # corr_line_prof_dic['prop']={'HARPN':{'20200730':{'ctrst_phase':{'pol':np.array([None,-9.428715e-02])},'FWHM_phase':{'pol':np.array([None,8.607855e-02])},
        ...
        # corr_line_prof_dic['prop']={'HARPS':{'20140406':{'ctrst_snr':{'pol':np.array([None,-1.240177e-03])}},'20180201':{'ctrst_snr':{'pol':np.array([None,-3.768760e-04])}}}}     #new
        corr_line_prof_dic['prop']={'HARPS':{'20140406':{'ctrst_snr':{'pol':np.array([None,-1.931094e-03])}}}}     #kitcat, final

        corr_line_prof_dic['prop'].update({'CARMENES_VIS':{'20180224':{'FWHM_phase':{'pol':np.array([None,-1.341420e-01])}}}})      #final
        # corr_line_prof_dic['prop'].update({'CARMENES_VIS':{'20180224':{'FWHM_snr':{'pol':np.array([None,4.511839e-04])}}}})          
        
        
    elif gen_dic['star_name']=='WASP166':
        # corr_line_prof_dic['prop']={'HARPS':{'20170304':{'FWHM_snr':{'pol':np.array([None,3.380117e-03,-7.161555e-05,4.802533e-07])}}}}     #new
        # corr_line_prof_dic['prop']={'HARPS':{'20170304':{'ctrst_snr':{'pol':np.array([None,2.722663e-05])}}}}     #kitcat
        corr_line_prof_dic['prop']={'HARPS':{'20170304':{'ctrst_phase':{'pol':np.array([None,-3.306329e-02])}}}}     #kitcat, final

    elif gen_dic['star_name']=='HAT_P11':
        corr_line_prof_dic['prop']={'CARMENES_VIS':
        ...
        corr_line_prof_dic['prop']={'ESPRESSO':
    ...
    if gen_dic['star_name']=='55Cnc':
        ...
        corr_line_prof_dic['PC_model']={
            ...
            # #Pour correction res + fit joint CCFintr vis indiv
            #   'ESPRESSO':{
            ...
            #Pour correction res + fit joint CCFintr all visits
            # 'ESPRESSO':{
            #       '20200205':{'all':'/Users/bourrier/Travaux/ANTARESS/En_cours/55Cnc_e_Saved_data/PCA_results/ESPRESSO/Range200/1PC/ESPRESSO_20200205_mooncorr_aligned.npz',
            ...
            #Pour correction res + fit joint CCFintr all visits (UPDATE)
            'ESPRESSO':{
    ...
    elif gen_dic['star_name']=='WASP76':data_dic['DI']['cont_range']=[[-150.,-40.],[40.,150.]]      
    ...
    elif gen_dic['star_name'] in ['WASP_8','55Cnc','WASP76','WASP127','HD209458','Corot7','Nu2Lupi','GJ9827','HIP41378']:
    ...
    if gen_dic['star_name']=='MASCARA1': 
        ...
        #Fit the entire star 
        #    - if enabled the stellar grid and corresponding broadband emission are re-calculated at each step of the minimization, varying the requested parameters in addition to the line profiles
        #    - this option cannot be used with chromatic intensity variations
        #    - this option is not required if only veq is varying 
        data_dic['DI']['mod_def']['ESPRESSO']['fit_star_grid']=True

    elif gen_dic['star_name']=='V1298tau': 
        data_dic['DI']['mod_def']['HARPN']={
            'mode':'glob_mod','coord_line':'mu','func_prof_name':'gauss'} 
        data_dic['DI']['mod_def']['HARPN']['fit_star_grid']=False
        
    elif gen_dic['star_name']=='HD209458': 
        data_dic['DI']['mod_def']['ESPRESSO']={
            'mode':'glob_mod','coord_line':'mu','func_prof_name':'gauss'} 
        data_dic['DI']['mod_def']['ESPRESSO']['fit_star_grid']=False
    ...
    # + multiple HDI intervals can be avoided by defined the density profile as a histogram (by setting its resolution 'HDI_dbins') or by 
    ...
    plot_dic['prop_raw']=''   #''  
    if gen_dic['star_name'] in ['HD189733','WASP43','L98_59','GJ1214']:plot_dic['prop_raw']='png'
    ...
    #    data_dic['DI']['sysvel']={'HARPN':-17.70}    #Hoeijmakers+2019
        ...
        if (gen_dic['type']['ESPRESSO']=='CCF'):data_dic['DI']['sysvel']={ 
                'ESPRESSO':{'20181030':-1.180597,'20180902':-1.172899}}    #measured from input CCFs  
        if (gen_dic['type']['ESPRESSO']=='spec2D'):data_dic['DI']['sysvel']={
    ...
    #RM survey
        ...
        if ('HARPN' in gen_dic['data_dir_list']):           
            if 'new' in gen_dic['data_dir_list']['HARPN']['20150913']:
                ...
                data_dic['DI']['sysvel']['HARPN']={'20150913':-6.34193e+01  ,'20151101':-6.34129e+01}         #from RVres (voigt model)
    ...
    #     - Correction will be performed within the 'corr_line_prof' module, after all other DI corrections. 
    # """
...
#        data_dic['DI']['idx_in_bin']['HARPN']={'2016-10-01':list(np.arange(9,dtype=int))+list(np.arange(30,36,dtype=int))}}        #mask G2/K5, Dalal+2019    decommenter pour parametres nominaux
    ...
    plot_dic['sp_DIbin']=''  
    plot_dic['CCF_DIbin']=''   #pdf  
    if gen_dic['star_name'] in ['HD189733','WASP43','L98_59','GJ1214']:plot_dic['CCF_DIbin']='png'

    #%%%% Residuals from binned profiles
    plot_dic['CCF_DIbin_res']=''  #pdf
...
#        data_dic['Res']['cont_range']=[[-300.,-60.],[60.,300.]]     #Mask F + atmo
    ...
    ##################################################################################################
    #%% Module: 2D->1D conversion for intrinsic spectra
    #    - every analysis afterwards will be performed on those profiles
    ##################################################################################################
    ...
    #    - options valid for original and binned profiles
    ##################################################################################################
    data_dic['Intr']['fit_prof'] = {}
...
#        data_dic['Intr']['fit_range']=[[-300.,300.]]   #mask F + atmo 
    ...
    if gen_dic['star_name']=='WASP76':
        ...
        data_dic['Intr']['fit_range']=[[-100.,100.]]      #[[-80.,80.]]     
    if gen_dic['transit_pl']=='WASP127b':
        data_dic['Intr']['fit_range']=[[-150.,150.]]   
    if gen_dic['star_name']=='HD209458':data_dic['Intr']['fit_range']=[[-150.,150.]]  
    if gen_dic['star_name']=='HD3167': 
        data_dic['Intr']['fit_range']=[[-26.,26.]]
        data_dic['Intr']['fit_range']=[[-50.,50.]]
...
#        data_dic['Intr']['idx_force_det']={'binned':{'HARPS-binned':{7:False,8:False,9:False,10:False}}}      #Mask F + atmo
    ...
    glob_fit_dic['PropLoc']['prop'] = 'ctrst'
    ...
    if gen_dic['star_name'] in ['WASP107','HAT_P11']:glob_fit_dic['PropLoc']['pol_mode']='modu'    
...
#     elif gen_dic['main_pl']=='WASP76b':    
    
#         p_start.add_many(('veq',13.8318133272886, True , 0. , None, None),  
#                          #('veq',9.7705730e+01, True , 0. , None, None),
#                         #('inclin_rad__'+pl_loc,88.489694*np.pi/180.  , True & False , 0. , np.pi/2., None),
#                         # ('aRs__'+pl_loc,3.8219354549605975 , False , 0. , None, None),
#                         # ('alpha_rot',7.9316453e-02, True & False , -1. , 1., None),  
#                         # ('beta_rot',0., False , None , None, None),  
#                         # ('cos_istar',np.cos(8.1384764*np.pi/180.), True & False , -1. , 1., None),  
#                         ('lambda_rad__'+pl_loc,8.7201724e+01*np.pi/180., True , -np.pi , np.pi, None))  
#                         # ('c1_CB',0., False , None , None, None),  
#                         # ('c2_CB',0., False , None , None, None),  
#                         # ('c3_CB',0., False , None , None, None)) 
...
#     elif gen_dic['main_pl']=='HD209458b':    
    
#         p_start.add_many(('veq',4.7, True , 0. , None, None),
...
#                  })         
    ...
    #%%%% Printing fits results
    glob_fit_dic['PropLoc']['verbose']=True
...
#            'plot1s_1D':False
    ...
    plot_dic['chi2_fit_loc_prop']=''   #pdf      
...
#            'ESPRESSO':{'2018-10-31':range(2,13)+range(27,36),'2018-09-03':range(1,8)+range(14,20)},
    ...
    elif gen_dic['transit_pl']=='Corot7b':glob_fit_dic['IntrProf']['idx_in_fit']={'ESPRESSO':{'2019-02-20':range(0,10)}}
    elif gen_dic['transit_pl']=='GJ9827d':
   ...
   #     #Parametres associes
    ...
    if gen_dic['star_name']=='WASP76':     
        glob_fit_dic['IntrProf']['mcmc_set']={'nwalkers':20,'nsteps':100,'nburn':0}                  
    elif gen_dic['star_name']=='Corot7':     #38 s for 1000 pts 
...
#            'plot1s_1D':False
    ...
    '''
    Building estimates for local stellar profiles 
    ...
    # + see possible fit dimensions in glob_fit_dic['IntrProf']['dim_fit']  
    ...
    data_dic['Intr']['opt_loc_data_corr']={'nthreads':14}
    ...
    # + DI_CCF : for the definition of model continuum and fitted ranges in DI CCF fits, and corrections of DI CCFs 
    # + Res_CCF: for the definition of errors on residual CCFs
    ...
    if gen_dic['transit_pl']=='WASP121b':data_dic['Atm']['no_plrange']=['DI_CCF','DI_Mast','Res_CCF','Intr']
        ...
        data_dic['Atm']['no_plrange']=[]
    # elif gen_dic['star_name']=='HAT_P33':data_dic['Atm']['no_plrange']=['DI_CCF','DI_Mast','Intr']
    ...
    '''
    Analysis of individual atmospheric profiles
        - currently defined for CCF only
        - options valid for original and binned profiles
    '''
    data_dic['Atm']['fit_prof'] = {}
    ...
    '''
    Analyses of atmospheric spectra
        - profiles must have been defined in the planet rest frame
        - for 2D spectra, analyses will be applied to their conversion into 1D spectra
    '''    

    #Activate
    gen_dic['ana_Atm']=True  & False
    gen_dic['ana_Atmbin']=True  & False   
    gen_dic['ana_Atmbinmultivis']=True  & False    

    #Range or combination of ranges over which calculate mean integrated signal
    #    - in planet rest frame (km/s or A)
    data_dic['Atm']['int_sign_range']=[[-40.,30.]]        
...
#            'ESPRESSO':{'2018-10-31':range(2,13)+range(27,36),'2018-09-03':range(1,8)+range(14,20)},
    ...
    if not gen_dic['grid_run']:
        ANTARESS_main(data_dic,mock_dic,gen_dic,theo_dic,plot_dic,glob_fit_dic,corr_line_prof_dic,PropAtm_fit_dic,AtmProf_fit_dic, corr_spot_dic,all_system_params[gen_dic['star_name']])
    ...
    #Run over a grid of properties
        ...
        #         gen_dic['order_range']['ESPRESSO'] = [2*iord,2*iord+1] 
                
        #         ANTARESS_main(data_dic,mock_dic,gen_dic,data_dic['Res'],data_dic['DI'],data_dic['Atm'],theo_dic,plot_dic,data_dic['Intr'],glob_fit_dic['PropLoc'],glob_fit_dic['IntrProf'],corr_line_prof_dic,PropAtm_fit_dic,AtmProf_fit_dic, corr_spot_dic, glob_fit_dic['ResProf'],stars_params,planets_params)
        ...
        for iord in range(69): 
            ...
            if iord not in [53,54,60,63,64]:   #New masks
                gen_dic['order_range']['HARPN']=[iord] 
