...
def ANTARESS_settings(data_dic,mock_dic,gen_dic,theo_dic,plot_dic,glob_fit_dic,detrend_prof_dic):
    ...
    gen_dic['studied_pl'] = {'TIC455b':{'ESPRESSO':['20240130']}}
    # gen_dic['studied_pl'] = {'TIC455b':{'ESPRESSO':['20240131']}}
    ...
    gen_dic['Tcenter_visits'] = {}#{'TIC455b':{'ESPRESSO':{'20240130':2458600.34299}}}
    ...
    gen_dic['calc_proc_data']= True & False # For processing from the start different orders/exposures
    ...
    gen_dic['sp_frame']='air' # Because ESPRESSO
    ...
    gen_dic['CCF_mask'] = {}
    # gen_dic['CCF_mask']['ESPRESSO'] = '/Users/alexisheitzmann/Documents/ESPRESSO_TIC_455000299/ESPRESSO_run/Antaress_analysis/TIC455/TIC455b_Saved_data/CCF_masks_DI/ESPRESSO_20240130/CCF_mask_DI_TIC455_ESPRESSO_t5.0.fits' # First mask obtained  
    ...
    # Transit night
    gen_dic['data_dir_list']={'ESPRESSO':{'20240130':'/Users/alexisheitzmann/Documents/ESPRESSO_TIC_455000299/ESPRESSO_run/Antaress_analysis/TIC_455000299/2024-01-30/'}}
    # test night
    # gen_dic['data_dir_list']={'ESPRESSO':{'20240131':'/Users/alexisheitzmann/Documents/ESPRESSO_TIC_455000299/ESPRESSO_run/Antaress_analysis/TIC_455000299/2024-01-31/'}}
    ...
    gen_dic['used_exp']={}
    # gen_dic['used_exp']={'ESPRESSO':{'20240130':range(5,13)}}  # test for quick reduction
    ...
    # if gen_dic['star_name'] == 'TIC455':
    #     gen_dic['masked_pix'] = {'ESPRESSO':{'20240130':{'exp_list':[],'ord_list':{ 100:[[5460.,5470.]],
    #                                                                                 108:[[5665.,5675.]],108:[[5710.,5730.]],
    #                                                                                 110:[[5710.,5730.]],
    #                                                                                 112:[[5765.,5780.]],112:[[5815.,5845.]],
    #                                                                                 114:[[5815.,5845.]],
    #                                                                                 116:[[5815.,5845.]],
    #                                                                                 118:[[5940.,5955.]],118:[[5985.,6020.]],
    #                                                                                 120:[[5985.,6020.]],120:[[6045.,6080.]],
    #                                                                                 122:[[6045.,6080.]],122:[[5985.,6020.]],
    #                                                                                 124:[[6045.,6080.]],124:[[6105.,6135.]],
    #                                                                                 126:[[6170.,6200.]],126:[[6225.,6255.]],
    #                                                                                 128:[[6225.,6255.]],
    #                                                                                 130:[[6290.,6325.]],
    #                                                                                 132:[[6290.,6325.]],132:[[6350.,6395.]],
    #                                                                                 134:[[6430.,6470.]],
    #                                                                                 136:[[6430.,6470.]],136:[[6495.,6540.]],
    #                                                                                 138:[[6495.,6540.]],138:[[6560.,6600.]],138:[[6620.,6680.]],
    #                                                                                 140:[[6620.,6680.]],
    #                                                                                 142:[[6620.,6680.]],142:[[6710.,6750.]],
    #                                                                                 144:[[6780.,6820.]],
    #                                                                                 146:[[6860.,6970.]],
    #                                                                                 148:[[6860.,6970.]],
    #                                                                                 150:[[7015.,7060.]],
    #                                                                                 152:[[7100.,7140.]],152:[[7150.,7240.]],
    #                                                                                 154:[[7150.,7240.]],
    #                                                                                 156:[[7150.,7240.]],156:[[7270.,7320.]],
    #                                                                                 158:[[7360.,7400.]],
    #                                                                                 160:[[7440.,7500.]],
    #                                                                                 162:[[7520.,7680.]],
    #                                                                                 164:[[7520.,7680.]],164:[[7680.,7691.]],164:[[7716.,7747.]],
    #                                                                                 166:[[7716.,7747.]],166:[[7750.,7787.]],
    #                                                                                 168:[[7812.,7900.]],
    #                                                                                 } } } }
        # Changing indices when orders are deleted
        #for iord in [104,106,146,148,162,164]:gen_dic['masked_pix']['ESPRESSO']['20240130']['ord_list'][iord+1] = gen_dic['masked_pix']['ESPRESSO']['20240130']['ord_list'][iord]
    ...
    #    - the CCF mask generation (gen_       dic['def_DImasks']) and spectral detrending (gen_dic['detrend_prof']) require the stellar continuum to have been estimated with this module
    ...
    gen_dic['calc_Intr_stcont'] = False    
    ...
    if gen_dic['star_name'] in ['TIC455']:
    ...
    #%%%% Multi-threading
    gen_dic['gcal_nthreads'] =  int(0.5*cpu_count())         
    ...
    gen_dic['gcal_binw'] = {'ESPRESSO': 0.2}
    ...
    gen_dic['gcal_thresh']= {'ESPRESSO':{'outliers':5.,'global':3e6}} # From Vincent's settings for HD209458
    ...
    #    - format: : {inst : [x1,x2] }  
    gen_dic['gcal_nooutedge']={} #{'ESPRESSO':[2.,0.]}
    ...
    #%%%% Multi-threading
    gen_dic['tell_nthreads'] =   int(0.5*cpu_count())          
...
#             '20180902' : {
#             'O2':{'Pressure_LOS':{ 'vary' : True , 'value':0.16 , 'min':0.1, 'max':0.25 }}},
#             '20210830' : {
...
# }   
    ...
    #%%%% Multi-threading
    gen_dic['Fbal_nthreads'] = int(0.5*cpu_count())          
    ...
    #%%%%% Activating
    gen_dic['corr_Fbal']=False 
    
    
    #%%%%% Calculating/retrieving
    gen_dic['calc_corr_Fbal']=False
    ...
    gen_dic['Fbal_bin_nu'] = {'ESPRESSO':0.9} 
    ...
    if gen_dic['star_name'] == 'TIC455':
        gen_dic['Fbal_ord_fit'] = {'ESPRESSO':{'20240130': list(np.concatenate((range(0,2),
                                                                                range(14,24),
                                                                                # range(0,24),
                                                                                range(26,40),
                                                                                range(42,70),
                                                                                range(72,90),
                                                                                range(92,167))))}}           
        # gen_dic['Fbal_ord_fit'] = {'ESPRESSO':{'20240130': range(4,166)}}      
    ...
    # if gen_dic['star_name'] == 'TIC455':
    #     gen_dic['Fbal_expvar'] = 0.4   
    
    
    #%%%%%% Automatic sigma-clipping
    #    - applied to the scaling with the measured visit master only
    gen_dic['Fbal_clip'] = False  
    ...
    if gen_dic['star_name'] == 'TIC455':
        gen_dic['Fbal_smooth'] = {'ESPRESSO':{'20240130':3e-5}}
    ...
    #%%%%% Activating
    #    - for 2D spectra only
    gen_dic['corr_FbalOrd']=False           # Not done for ESPRESSO due to wiggle pattern
    ...
    # inst > val
    #    - in A
    gen_dic['FbalOrd_binw'] = {'ESPRESSO':2.}
    ...
    #%%%%% Activating
    gen_dic['corr_Ftemp']= False ## not used for now
    ...
    #%%%% Multi-threading
    gen_dic['cosm_nthreads'] = int(0.5*cpu_count())           
    ...
    gen_dic['cosm_thresh'] = {} 
    if gen_dic['star_name'] == 'TIC455':
        gen_dic['cosm_thresh'] = {'ESPRESSO':{'20240130': 8} }
    ...
    #%%%% Calculating/retrieving 
    gen_dic['calc_permpeak']=False  
    
    
    #%%%% Multi-threading
    gen_dic['permpeak_nthreads'] = int(0.5*cpu_count())      
    ...
    if gen_dic['star_name']=='TIC455':
      gen_dic['wig_range_fit'] = {'20240130':[[20.,39.1],[39.5,43.4],[43.7,45.5],[45.9,56.2],[58.,61.5],[61.9,66.]] }
    ...
    gen_dic['detrend_prof'] = False
        ...
        #%%%% Calculating/retrieving 
    gen_dic['calc_detrend_prof']=False 
    ...
    gen_dic['calc_fit_DI_1D']= True  &False
    ...
    data_dic['DI']['cont_range'] = {'ESPRESSO':{0:[[15-40.,15-15.],[15+15.,15+40.]]}}
    ...
    data_dic['DI']['mod_prop']={
                                'rv':{'vary':True,'ESPRESSO':{'20240130':{'guess':15.,'bd':[5.,15.]}}},
                                'ctrst':{'vary':True,'ESPRESSO':{'20240130':{'guess':0.3,'bd':[0.2,0.4]}}},
                                'FWHM':{'vary':True,'ESPRESSO':{'20240130':{'guess':10.,'bd':[2.,8.]}}}
                                        }   
    ...
    #%%%% Multi-threading
    glob_fit_dic['DIProp']['nthreads'] = int(0.5*cpu_count())
    ...
    if gen_dic['star_name'] == 'TIC455':
        data_dic['DI']['sysvel']={'ESPRESSO':{'20240130':1.4217e+01}} #
        # data_dic['DI']['sysvel']={'ESPRESSO':{'20240131':1.4217e+01}}
    ...
    if gen_dic['star_name'] == 'TIC455':
        data_dic['DI']['system_prop']={'achrom':{'LD':['quadratic'],
                                                 'LD_u1':[0.71],'LD_u2':[0.08], ### quadratic limb darkening EXOFAST = ( 0.70600425     0.078583496)
                                                 'TIC455b':[0.0412]}}#
    ...
    data_dic['DI']['idx_ecl']={}
    if 'TIC455' == gen_dic['star_name']:
            data_dic['DI']['idx_ecl']={'out':{'ESPRESSO': {'20240130':range(29) }}}
...
#     if gen_dic['star_name']=='TIC455':
#         data_dic['DI']['idx_in_bin']={'ESPRESSO': {'20240130':range(14,29)}}
# #        print(data_dic['DI']['idx_in_bin']['ESPRESSO']['20240130'])
    ...
    if gen_dic['star_name'] == 'TIC455':
        data_dic['DI']['prop_bin']={'ESPRESSO':{'20240130':{'bin_range':[-0.5,0.5],'nbins':1}}}
    ...
    #%%%% Multi-threading
    data_dic['DI']['mask']['nthreads'] = int(0.2*cpu_count())       
    ...
    data_dic['DI']['mask']['fwhm_ccf'] = 10.65 
    ...
    data_dic['DI']['mask']['vicinity_fwhm'] = {}#{'ESPRESSO' : 0.}
    ...
    #    - format: {inst:value}    
    data_dic['DI']['mask']['dw_reg'] = {}#{'ESPRESSO':0.008}
    
    
    #%%%%% Smoothing window   
    #    - in pixels, used for spectrum and derivative 
    #    - format: {inst:value}
    data_dic['DI']['mask']['kernel_smooth']={'ESPRESSO':50}
    data_dic['DI']['mask']['kernel_smooth_deriv2']={'ESPRESSO':30}
    ...
    # data_dic['DI']['mask']['line_rej_range'] = {'ESPRESSO':[[5460.,5470.],
    #                                                         [5665.,5675.],
    #                                                         [5710.,5730.],
    #                                                         [5710.,5730.],
    #                                                         [5765.,5780.],
    ...
    data_dic['DI']['mask']['sel_ld'] = True #& False
    data_dic['DI']['mask']['linedepth_cont_min'] = {'ESPRESSO':0.1}
    data_dic['DI']['mask']['linedepth_min'] = {'ESPRESSO':0.1}
    data_dic['DI']['mask']['linedepth_cont_max'] = {'ESPRESSO':0.9}   
    data_dic['DI']['mask']['linedepth_max'] = {'ESPRESSO':0.9}      
    ...
    data_dic['DI']['mask']['sel_ld_lw'] = True #& False
    data_dic['DI']['mask']['line_width_logmin'] = -2
    data_dic['DI']['mask']['line_depth_logmin'] = -2
    ...
    data_dic['DI']['mask']['sel_RVdev_fit'] = True #& False
    data_dic['DI']['mask']['win_core_fit'] = 0.7
    data_dic['DI']['mask']['abs_RVdev_fit_max'] = 250
    
    
    #%%%% Line selection: tellurics
    data_dic['DI']['mask']['sel_tellcont'] = True #& False
    ...
    data_dic['DI']['mask']['tell_star_depthR_max'] = 0.5
    data_dic['DI']['mask']['tell_star_depthR_max_final'] = 0.05
    ...
    data_dic['DI']['mask']['sel_vald_depthcorr'] = True & False 
    ...
    data_dic['DI']['mask']['VALD_depth_corr'] = True & False
    ...
    data_dic['DI']['mask']['sel_morphasym'] = True #& False
    ...
    data_dic['DI']['mask']['sel_morphshape'] = True #& False 
    data_dic['DI']['mask']['width_max'] = 18. 
    ...
    data_dic['DI']['mask']['sel_RVdisp'] = True & False
    ...
    data_dic['DI']['mask']['absRV_max'] = {'ESPRESSO':500.}
    ...
    data_dic['DI']['mask']['RVdisp_max'] = {'ESPRESSO':200.}  


    #%%%%% Analysis of LBL properties for each exposures
    data_dic['DI']['mask']['indiv_exp'] = True
    ...
    plot_dic['DImask_spectra'] = 'png'
    
    
    #%%%%% Depth range selection
    plot_dic['DImask_ld'] = 'png'
    
    
    #%%%%% Minimum depth and width selection
    plot_dic['DImask_ld_lw'] = 'png'
    
    
    #%%%%% Position selection
    plot_dic['DImask_RVdev_fit'] = 'png'
    
    
    #%%%%% Telluric selection
    plot_dic['DImask_tellcont'] = 'png'

    
    #%%%%% VALD selection
    plot_dic['DImask_vald_depthcorr'] = 'png'
    
    
    #%%%%% Morphological (asymmetry) selection
    plot_dic['DImask_morphasym'] = 'png'
    ...
    #%%%% Calculating/retrieving 
    gen_dic['calc_diff_data'] = False 
    
    
    #%%%% Multi-threading
    gen_dic['nthreads_diff_data']= int(0.5*cpu_count())      
    ...
    # data_dic['Diff']['cont_range']={'ESPRESSO':{0:[[-100.,-50.],[50.,100.]]}}
    ...
    #%%%% Multi-threading
    glob_fit_dic['IntrProp']['nthreads'] = int(0.5*cpu_count())
    ...
    #%%%%% Allocated threads
    glob_fit_dic['DiffProf']['nthreads'] = int(0.5*cpu_count())
    ...
    #%%%%% Allocated threads
    glob_fit_dic['IntrProf']['nthreads'] = int(0.5*cpu_count())
    ...
    data_dic['Intr']['opt_loc_prof_est']={'nthreads':int(0.5*cpu_count()),'corr_mode':'glob_mod','mode':'ana','def_range':[],'def_iord':0}
    ...
    #%%%% Multi-threading
    glob_fit_dic['AtmProp']['nthreads'] = int(0.5*cpu_count())
...
def ANTARESS_2D_1D_settings(data_type,local_dic,gen_dic,plot_dic):
    ...
    if gen_dic['star_name'] == 'TIC455':
        gen_dic['spec_1D_'+data_type] =     True  #&False
        gen_dic['calc_spec_1D_'+data_type]= True  &False  
        
        
    #%%%% Multi-threading
    gen_dic['nthreads_spec_1D_'+data_type]= int(0.2*cpu_count())
    ...
    local_dic[data_type]['spec_1D_prop']={}#{'ESPRESSO':{'dlnw':0.01/6000.,'w_st':3000.,'w_end':9000.}}  
...
def ANTARESS_CCF_settings(data_type,gen_dic):
    ...
    #%%%% Activating
    gen_dic[data_type+'_CCF'] = True &False
    
    
    #%%%% Calculating/retrieving 
    gen_dic['calc_'+data_type+'_CCF']= True &False      
