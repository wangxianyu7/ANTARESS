...
def gen_plot_default(plot_settings,key_plot,plot_dic,gen_dic,data_dic):
    ...
    plot_options['plot_pre']='raw'
    plot_options['plot_post']='all'        
...
def ANTARESS_plot_settings(plot_settings,plot_dic,gen_dic,data_dic,glob_fit_dic,theo_dic):
    ...
    if gen_dic['specINtype']:
        ...
        if (plot_dic['gcal_all']!='') or (plot_dic['gcal_ord']!='') or (plot_dic['noises_ord']!=''):
            ...
            # extras
            plot_settings[key_plot]['iexp2plot']={'ESPRESSO':{'20240130':[5,13,19]}}  
            
            plot_settings[key_plot]['legend']=True
        ...
        if (plot_dic['tell_CCF']!=''):
            ...
            # y range
            plot_settings[key_plot]['y_range_disp']=[0.4,1.2]
        ...
        if (plot_dic['Fbal_corr']!=''):   
            ...
            #%%%%% Overplot all exposures or offset them
            plot_settings[key_plot]['gap_exp']=0.01        
    ...
    if gen_dic['specINtype'] and (plot_dic['flux_sp']!=''):
        ...
        # plot_settings[key_plot]['x_range'] = [6500,7500]

        # plot_settings[key_plot]['iord2plot'] = 
        
        plot_settings[key_plot]['multi_ord']=True 

        # plot_settings[key_plot]['iexp2plot'] = {'ESPRESSO':{
                                                            # '20240130':[8]
                                                            # '20240130':[5,6,7],   
                                                            # }} 
        

        # plot_settings[key_plot]['iord2plot']=range(137,139)
    ...
    for data_mode in ['DI','Intr']: 
        ...
        if plot_dic[data_mode+'mask_spectra']!='':
            ...
            plot_settings[key_plot]['step']='sel0'      
        ...
        if mask_dic['sel_RVdisp'] and (plot_dic[data_mode+'mask_RVdisp']!=''):
            ...
            plot_settings[key_plot]['y_bins_par'] = 40    
            plot_settings[key_plot]['y_log_hist'] = False
            plot_settings[key_plot]['x_range_hist'] = [-50,1000]
            plot_settings[key_plot]['y_range_hist'] = [-1,6]
