...
def process_spectral_cont(vis_mode,data_type_gen,inst,data_dic,gen_dic,vis):
    ...
    #Processing data    
    save_data_paths = gen_dic['save_data_dir']+'Stellar_cont_'+data_type_gen+'/'
    ...
    if (gen_dic['calc_'+data_type_gen+'_stcont']):
        ...
        #Saving data     
        datasave_npz(save_data_paths+'St_cont_'+inst+'_'+vis_det,{'cont_func_dic': cont_func_dic[0]})

    else:
        data_paths={'path':save_data_paths+'St_cont_'+inst+'_'+vis_det}
