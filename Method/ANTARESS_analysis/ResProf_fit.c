...
double* C_OS_coadd_loc_line_prof(double* rv_surf_star_grid, double* ctrst_grid, double* FWHM_grid, double* args_cen_bins, double* Fsurf_grid_spec, int args_ncen_bins, int Fsurf_grid_spec_shape_0) 
{
