...
#            plot_settings[key_plot]['color_dic']={'2018-10-31':'dodgerblue','2018-09-03':'red'}       
    ...
    ################################################################################################################ 
    #%%% Persistent peaks correction master
    ################################################################################################################ 
    ...
    if gen_dic['specINtype'] and (plot_dic['sp_raw']!=''):
        ...
        if gen_dic['star_name']=='WASP107':
            ...
            plot_settings[key_plot]['orders_to_plot']=np.arange(110,170)
            plot_settings[key_plot]['orders_to_plot']=[112,114,116,118,120]
            plot_settings[key_plot]['orders_to_plot']=[48,50,52,54,56,58,60,62,64]
            plot_settings[key_plot]['orders_to_plot']=[52,54,56,58,60]
        ...
        if gen_dic['star_name']=='HD189733':
            plot_settings[key_plot]['plot_tell'] = True & False
...
#            plot_settings[key_plot]['plot_post']='tell' 
        ...
        if gen_dic['star_name']=='HD189733':
            ...
            plot_settings[key_plot]['plot_pre']='fbal'
            plot_settings[key_plot]['plot_post']='wig'
        ...
        if gen_dic['star_name']=='HD189733':
            ...
            plot_settings[key_plot]['y_range']=[1e5,9e6]
            plot_settings[key_plot]['y_range']=[1e5,4e6]
    ...
    if gen_dic['specINtype'] and (plot_dic['trans_sp']!=''):
        ...
        plot_settings[key_plot]['bin_width'] = 10.     #wav, Fbal sampling
        plot_settings[key_plot]['bin_width'] = 2.      #wav, wig 
        plot_settings[key_plot]['bin_width'] = 0.08      #wav, Na 
        ...
        plot_settings[key_plot]['x_range'] = [5884.,5902.]  #Na
        # plot_settings[key_plot]['x_range'] = [c_light/53.,c_light/49.]    #bump de Fbal dans region Na, HD209    
        # plot_settings[key_plot]['x_range'] = [4500,4700.]
        # plot_settings[key_plot]['x_range'] = [3750.,7900.]  #full ESPRESSO
        plot_settings[key_plot]['x_range'] = [5870.,5916.]  #Na
        
        #Vertical range
        plot_settings[key_plot]['y_range'] = [0.98,1.02]
        plot_settings[key_plot]['y_range'] = [0.96,1.04]        
        ...
        #Marker
        plot_settings[key_plot]['marker'] = None
        ...
        # + 'cosm' : after cosmics correction  
        # + 'permpeak' : after persistent peak correction 
        # + 'wig' : after ESPRESSO wiggle correction
    ...
    if ((plot_dic['DI_prof']!='') or (plot_dic['DI_prof_res']!='')):
        for key_plot in ['DI_prof','DI_prof_res']:
            if plot_dic[key_plot]!='':
                ...
                plot_settings[key_plot]['margins']=[0.15,0.2,0.95,0.75]   #ANTARESS I, fit CCF DI

                #Font size
                plot_settings[key_plot]['font_size']=18   #ANTARESS I, mock, multi-tr, fit CCF DI

                #Linewidth
                plot_settings[key_plot]['lw_plot']=1.   #ANTARESS I, mock, multi-tr, fit CCF DI
        
                #Choose profiles to plot
                #    - 'raw' : input profiles
                #    - 'conv' : converted from spectra
                plot_settings[key_plot]['step']='raw'  
                # plot_settings[key_plot]['step']='conv'  
        ...
        #                'HARPS':['14-01-18','09-01-18','31-12-17'],   
                ...
                # elif gen_dic['star_name']=='WASP76':
                #     plot_settings[key_plot]['visits_to_plot']={'ESPRESSO':['20181031','2018-09-03','binned']}  
                #     plot_settings[key_plot]['visits_to_plot']={'ESPRESSO':['20181030']}  
                ...
                #Choice of order to plot
                if gen_dic['star_name']=='WASP76':plot_settings[key_plot]['orders_to_plot']=2      #after trimming 
                ...
                #     plot_settings[key_plot]['x_range']=[-150.,150.] 
                #     plot_settings[key_plot]['x_range']=[-120.,120.]    #ANTARESS I fit CCF DI
                    plot_settings[key_plot]['x_range']=[5885.,5896.]                 
                
                elif gen_dic['studied_pl']=='WASP127b':plot_settings[key_plot]['x_range']=[-32.,12.] 
                elif gen_dic['star_name']=='HD209458':
                    plot_settings[key_plot]['x_range']=[-40.,20.] 
                    plot_settings[key_plot]['x_range']=[-100.,70.] 
                ...
                plot_settings[key_plot]['shade_cont']=True     
               
                #Shade area not included in fit
                plot_settings[key_plot]['shade_unfit']=True   
                
                #Shade planet-excluded ranges
                #   - correspond to ranges excluded from the profile analysis
                if gen_dic['star_name']=='WASP76':plot_settings[key_plot]['plot_plexc'] = True
        ...
        if (plot_dic['DI_prof']!=''):  
            ...
            if gen_dic['star_name']=='HD209458':
                ...
                plot_settings[key_plot]['y_range']=None
                plot_settings[key_plot]['y_range']=[0.5,1.05] 
                ...
                plot_settings[key_plot]['y_range']=[0.4,1.05] 
                plot_settings[key_plot]['y_range']=[0.,1.2]    #NaI D2 
            ...
            #Plot fitted pixels 
            plot_settings[key_plot]['plot_fitpix']=True  
    ...
    if ((plot_dic['DIbin']!='') or (plot_dic['DIbin_res']!='')):
        for key_plot in ['DIbin','DIbin_res']:
            if plot_dic[key_plot]!='':
                ...
                #Errors
                plot_settings[key_plot]['plot_err']=True
        
                #Instruments and visits to plot
                if gen_dic['star_name']=='WASP76':
                    plot_settings[key_plot]['visits_to_plot']={'ESPRESSO':['20181030','20180902']}   
                ...
                #Bornes du plot en RV
                if ('CCF' in data_dic['DI']['type'].values()):
                    if gen_dic['studied_pl']==['HD3167_c']:
                    ...
                    if gen_dic['star_name']=='HD209458':
                        plot_settings[key_plot]['x_range']=[-100.,100.]    #Zoom   
                        
                #Plot boundaries in wav
                if (any('spec' in s for s in data_dic['DI']['type'].values())): 
                    if gen_dic['star_name']=='WASP76':
                        plot_settings[key_plot]['x_range']=[3500.,8000.] 
                        plot_settings[key_plot]['x_range']=[5880.,5905.] 
                        plot_settings[key_plot]['x_range']=[6850.,6950.] 
                        plot_settings[key_plot]['x_range']=[5885.,5895.]    
                        plot_settings[key_plot]['x_range']=[5847.3-0.5 , 5848.75+0.5]
                        plot_settings[key_plot]['x_range']=[5851.45-0.5  , 5852.94+0.5 ]
                        plot_settings[key_plot]['x_range']=[5852.5 -0.5  , 5854.8+0.5 ]    
                        plot_settings[key_plot]['x_range']=[5854.54 -0.5  , 5855.70+0.5 ]                 
                        plot_settings[key_plot]['x_range']=[5855.36  -0.5  ,5856.77+0.5 ]                   
                        plot_settings[key_plot]['x_range']=[5861.33  -0.5  ,5863.57+0.5 ]                
                        plot_settings[key_plot]['x_range']=[5865.22  -0.5  ,5866.83+0.5 ]    
                        plot_settings[key_plot]['x_range']=[5929.04 -0.5  ,5931.+0.5 ]                       
                        
                        
                        # plot_settings[key_plot]['x_range']=None
                    if gen_dic['star_name']=='HD209458':
                        plot_settings[key_plot]['x_range']=[5884.,5902.]             
                ...
                #Print fit properties on plot
                plot_settings[key_plot]['plot_prop']=True    #  &   False
                plot_settings[key_plot]['font_size_txt'] = 10
        
                #-----------------------------------
                #Plot each disk-integrated profile and its fit
                if (key_plot=='DIbin'):

                    #Plot boundaries in flux
                    if gen_dic['star_name']=='WASP76':
                        # plot_settings[key_plot]['y_range']=[0.,2.] 
                        # plot_settings[key_plot]['y_range']=[0.,1.2] 
                        plot_settings[key_plot]['y_range'] = None
                    if gen_dic['star_name']=='HD209458':
                        plot_settings[key_plot]['y_range']=[0.05,1.05]             
                    ...
                    #Overplot bissector
                    plot_settings[key_plot]['plot_biss']=True   & False        
        
                    #Plot fitted line profile
                    plot_settings[key_plot]['plot_line_model']=True  & False
            
                    #Plot model line profile
                    plot_settings[key_plot]['plot_line_model_HR']=True  & False
        
                    #Plot stellar continuum
                    plot_settings[key_plot]['st_cont'] = 'DI'
        
                #-----------------------------------
                #Plot each disk-integrated profile and its fit
                if (key_plot=='DIbin_res') and (gen_dic['fit_DI_gen']): 

                    #Margins
                    plot_settings[key_plot]['margins']=[0.15,0.15,0.95,0.5] 
                    
                    #Vertical range
                    if gen_dic['star_name']=='HD209458':
                        plot_settings[key_plot]['y_range']=[-0.04,0.04]   
...
#            plot_settings[key_plot]['x_range']=[6200.,6300.] 
    ...
    if ((plot_dic['DImask_RVdisp']!='') or (plot_dic['Intrmask_RVdisp']!='')):
        for key_plot in ['DImask_RVdisp','Intrmask_RVdisp']:
            if plot_dic[key_plot]!='':
                ...
                #Y range
                plot_settings[key_plot]['y_range']=None
                plot_settings[key_plot]['y_range']=[0.,5.]
    ...
    if (plot_dic['prop_DI']!=''):
        ...
        plot_settings['prop_DI_ordin']=['rv','FWHM','ctrst','AM', 'snr','rv_res','RVdrift']
        plot_settings['prop_DI_ordin']=['rv','rv_res','FWHM','ctrst','rv_pip','rv_pip_res','FWHM_pip','ctrst_pip']
        # plot_settings['prop_DI_ordin']=['AM', 'snr']        
        ...
        # plot_settings['prop_DI_ordin']=['ctrst','FWHM']
        # plot_settings['prop_DI_ordin']=['rv','rv_res','vsini','cont','ctrst_ord0__IS__VS_','FWHM_ord0__IS__VS_']
        # plot_settings['prop_DI_ordin']=['rv_res','FWHM','ctrst']
        # plot_settings['prop_DI_ordin']=['rv_l2c','FWHM_l2c','amp_l2c']
        # plot_settings['prop_DI_ordin']=['rv','rv_res','rv_pip','rv_pip_res']  
        # plot_settings['prop_DI_ordin']=['snr'] #vaulato
        # plot_settings['prop_DI_ordin']=['rv_res'] 
        # plot_settings['prop_DI_ordin']=['ctrst'] 
        # plot_settings['prop_DI_ordin']=['rv_res'] 
        # plot_settings['prop_DI_ordin'] = ['colcorrmin','colcorrmax']
        # plot_settings['prop_DI_ordin'] += ['snr','AM']        
        # plot_settings['prop_DI_ordin'] += ['seeing']   #vaulato  
        # plot_settings['prop_DI_ordin'] += ['satur_check']
    #    plot_settings['prop_DI_ordin']=['colcorr450','colcorr550','colcorr650']  
#        plot_settings['prop_DI_ordin']=['rv_res','rv_l2c','FWHM_l2c','amp_l2c']     
#        plot_settings['prop_DI_ordin']=['rv_res','FWHM_l2c','amp_l2c']  
#        plot_settings['prop_DI_ordin']=['rv','RV_lobe','amp','amp_lobe','FWHM','FWHM_lobe']          
        # plot_settings['prop_DI_ordin']=['wig_p_0', 'wig_p_1', 'wig_wref', 'wig_a_0', 'wig_a_1', 'wig_a_2', 'wig_a_3', 'wig_a_4']
        # plot_settings['prop_DI_ordin']=['rv_res']
        # plot_settings['prop_DI_ordin']=['AM']        
        # plot_settings['prop_DI_ordin']+=['az']  
        # plot_settings['prop_DI_ordin']=['ha','na']  
        # plot_settings['prop_DI_ordin']=['ADC1 POS','ADC1 RA','ADC1 DEC','ADC2 POS','ADC2 RA','ADC2 DEC']
        # plot_settings['prop_DI_ordin']=['TILT1 VAL1','TILT1 VAL2','TILT2 VAL1','TILT2 VAL2']        
        ...
        for plot_prop in plot_settings['prop_DI_ordin']:
            ...
            plot_settings[key_plot]['margins']=[0.15,0.12,0.95,0.6]   #ANTARESS I, mock, fit CCF DI
            plot_settings[key_plot]['margins']=[0.15,0.12,0.95,0.6]   

            #Font size
            plot_settings[key_plot]['font_size']=18   #ANTARESS I, mock, multi-tr

            #Abscissa
            plot_settings[key_plot]['prop_DI_absc']='phase'
            # plot_settings[key_plot]['prop_DI_absc']='ctrst'
            # plot_settings[key_plot]['prop_DI_absc']='FWHM'
            # plot_settings[key_plot]['prop_DI_absc']='snr'
            # plot_settings[key_plot]['prop_DI_absc']='snr_quad'
            # plot_settings[key_plot]['prop_DI_absc']='AM'
            # plot_settings[key_plot]['prop_DI_absc']='flux_airmass'
            # plot_settings[key_plot]['prop_DI_absc']='seeing'
            # plot_settings[key_plot]['prop_DI_absc']='colcorrmin'
            # plot_settings[key_plot]['prop_DI_absc']='PSFang'
            # plot_settings[key_plot]['prop_DI_absc']='alt'
            # plot_settings[key_plot]['prop_DI_absc'] = 's'
            # plot_settings[key_plot]['prop_DI_absc'] = 'ca'
            # plot_settings[key_plot]['prop_DI_absc'] = 'ha'
            # plot_settings[key_plot]['prop_DI_absc'] = 'na'
            ...
            if gen_dic['star_name']=='HD189733':
                plot_settings[key_plot]['visits_to_plot']={'ESPRESSO':['20210810','20210830']} 
            elif gen_dic['star_name']=='GJ3090':
            ...
            if gen_dic['star_name']=='WASP69':
                plot_settings[key_plot]['visits_to_plot']={'NIRPS_HE':['20230624','20230729','20230825'],'HARPS':['20120621','20230624','20230729','20230825'],'HARPN':['20160604','20160804']} 
        ...
        #    
            ...
            # plot_settings[key_plot]['idx_noplot'] = {'HARPN':{ '20200730':np.arange(90)}}
                ...
                # plot_settings[key_plot]['idx_noplot']={'ESPRESSO':{'20180902':list(range(14,20)),'20181030':list(range(29,41))}}      #exclusion des expos dans lesquelles raie ne peut pas etre ajustee individuellement (centroide dans plage planetaire exclue)        
                plot_settings[key_plot]['idx_noplot']={'ESPRESSO':{'20180902':list(range(12,22)),'20181030':list(range(26,44))}}      #exclusion des expos dans lesquelles raie ne peut pas etre ajustee individuellement (centroide dans plage planetaire exclue)         
        
        
        

            #Print data quality in the log and on the figure, and plot mean value
            #    - relative to 'all', 'out', 'in' data
            plot_settings[key_plot]['print_disp']= ['log','fig']
            ...
            # if gen_dic['star_name'] == 'WASP76':
            #     plot_settings[key_plot]['plot_HDI']=True
            #     plot_settings[key_plot]['nwalkers'] = 30
            ...
            if gen_dic['star_name']=='55Cnc':
                ...
                # plot_settings[key_plot]['color_dic']={'ESPRESSO':{'20180902':'rainbow','20181030':'rainbow'},'binned':{'ESP_binned':'black'}}                 
                plot_settings[key_plot]['color_dic']={'ESPRESSO':{'20180902':'dodgerblue','20181030':'red'}}   
                plot_settings[key_plot]['color_dic']={'ESPRESSO':{'20180902':'green','20181030':'darkorange'}}
                ...
                plot_settings[key_plot]['color_dic']={'ESPRESSO':{'20190720':'dodgerblue','20190911':'red'}} 
            ...
            # elif gen_dic['star_name']=='HAT_P3':plot_settings[key_plot]['color_dic']={'HARPN':{'20190415':'dodgerblue','20200130':'red'}}         
                ...
                plot_settings[key_plot]['color_dic']={'NIRPS_HE':{'20230624':'dodgerblue','20230729':'limegreen','20230825':'red'},'HARPS':{'20120621':'magenta','20230624':'dodgerblue','20230729':'limegreen','20230825':'red'},'HARPN':{'20160604':'orange','20160804':'purple'}}  
            ...
            if 1==0:
                ...
                if plot_settings[key_plot]['prop_DI_absc']=='phase':
                    if gen_dic['star_name']=='GJ436':dbin,bin_min,bin_max=0.003 ,-0.05  ,0.05
                        ...
                        plot_settings[key_plot]['bin_val']['NIRPS_HE'] = {'dbin':0.002,'bin_min':-0.025,'bin_max':0.035,'color':'black','alpha_bin':1}  
            
                if plot_settings[key_plot]['prop_DI_absc']=='snr':
            ...
            plot_settings[key_plot]['plot_data']=True 
            ...
            if gen_dic['studied_pl']=='WASP_8b':
                ...
                if plot_settings[key_plot]['prop_DI_absc']=='AM':            
            ...
            if gen_dic['star_name']=='WASP76':      
                if plot_settings[key_plot]['prop_DI_absc']=='phase':
                    plot_settings[key_plot]['x_range']=[-0.078,0.088]
            ...
            if gen_dic['star_name']=='GJ436':
                ...
                if plot_settings[key_plot]['prop_DI_absc']=='snr_quad':
                    plot_settings[key_plot]['x_range']=[31.,71.]   #ESPRESSO
    
                
            if gen_dic['studied_pl']=='HD209458b':
                if plot_settings[key_plot]['prop_DI_absc']=='phase': plot_settings[key_plot]['x_range']=[-0.031,0.041]       
            if gen_dic['studied_pl']==['HD3167_b']:
                if plot_settings[key_plot]['prop_DI_absc']=='phase':
                    plot_settings[key_plot]['x_range']=[-0.08,0.11]    #[-0.05,0.13] 
                    plot_settings[key_plot]['x_range']=[-0.075,0.115]    #[-0.05,0.13] 
                if plot_settings[key_plot]['prop_DI_absc']=='snr': plot_settings[key_plot]['x_range']=[30.,70.] 
                if plot_settings[key_plot]['prop_DI_absc']=='snr_quad': plot_settings[key_plot]['x_range']=[47.,99.] 
                ...
                if plot_settings[key_plot]['prop_DI_absc']=='ctrst':plot_settings[key_plot]['x_range']=[0.5755,0.577]  
                if plot_settings[key_plot]['prop_DI_absc']=='FWHM':plot_settings[key_plot]['x_range']=[7.133,7.141]   
            elif gen_dic['studied_pl']=='GJ9827d':
                plot_settings[key_plot]['x_range']=[-0.019,  0.022]     #ESPRESSO
                plot_settings[key_plot]['x_range']=[-0.04 ,  0.02 ]     #HARPS
                if plot_settings[key_plot]['prop_DI_absc']=='AM':plot_settings[key_plot]['x_range'] = [1.,2.5]
                if plot_settings[key_plot]['prop_DI_absc']=='seeing':plot_settings[key_plot]['x_range'] = [0.3,1.9] 
            elif gen_dic['studied_pl']=='GJ9827b':
                if plot_settings[key_plot]['prop_DI_absc']=='phase':plot_settings[key_plot]['x_range'] = [-0.16,0.1]
                if plot_settings[key_plot]['prop_DI_absc']=='AM':plot_settings[key_plot]['x_range'] = [1.1,2.4]
                if plot_settings[key_plot]['prop_DI_absc']=='seeing':plot_settings[key_plot]['x_range'] = [0.4,1.8] 
            if gen_dic['star_name']=='TOI858':    
                if plot_settings[key_plot]['prop_DI_absc']=='phase':plot_settings[key_plot]['x_range'] = [-0.035,0.05]            
            ...
            if gen_dic['star_name']=='HD15337':    
                ...
                if plot_settings[key_plot]['prop_DI_absc']=='phase': plot_settings[key_plot]['x_range']=[-0.042,0.053]  
        ...
        #                   }
            ...
            if 1==1:
                ...
                if 'visits_to_plot' in plot_settings[key_plot]:
                    for inst in plot_settings[key_plot]['visits_to_plot']:
                        ...
                        for vis in plot_settings[key_plot]['visits_to_plot'][inst]:plot_settings[key_plot]['deg_prop_fit'][inst][vis]={plot_settings[key_plot]['prop_DI_absc']:deg_corr}
            ...
            if gen_dic['star_name']=='WASP69':
                ...
                plot_settings[key_plot]['deg_prop_fit']['NIRPS_HE']['20230624'][var_corr]= 1
                plot_settings[key_plot]['deg_prop_fit']['NIRPS_HE']['20230729'][var_corr]= 1
                plot_settings[key_plot]['deg_prop_fit']['NIRPS_HE']['20230825'][var_corr]= 1
                ...
                plot_settings[key_plot]['deg_prop_fit']['HARPS']['20120621'][var_corr]= 0
            ...
            if (plot_prop=='rv'):
                ...
                if gen_dic['star_name']=='WASP76':
                    plot_settings[key_plot]['y_range']=[-1.28,-1.14]
                    if gen_dic['trim_spec']:plot_settings[key_plot]['y_range'] = None
            ...
            if (plot_prop=='rv_res'):
                ...
                if gen_dic['star_name']=='WASP76':
                    plot_settings[key_plot]['y_range']=[-10.,10.]    #ANTARESS I
                    if gen_dic['trim_spec']:plot_settings[key_plot]['y_range'] = None
                    if plot_settings[key_plot]['col_in']=='none':plot_settings[key_plot]['y_range']=[-15.,15.]
        ...
        #                    plot_settings[key_plot]['y_range']=[0.,10.]     #avec vsys connue
            ...
            if (plot_prop=='FWHM'):
                ...
                if gen_dic['star_name']=='55Cnc':    
                    if ('ESPRESSO' in data_dic['DI']) and (gen_dic['n_instru']==1) and plot_settings[key_plot]['norm_ref']:plot_settings[key_plot]['y_range']=[0.9993,1.0007] 
                if gen_dic['star_name']=='HD189733':
                    if plot_settings[key_plot]['col_in']=='none':plot_settings[key_plot]['y_range']=[0.999,1.001]
                if gen_dic['star_name']=='HD209458':
                    if plot_settings[key_plot]['col_in']=='none':plot_settings[key_plot]['y_range']=[0.9985,1.0015] 
                if gen_dic['star_name']=='WASP76':
                    plot_settings[key_plot]['y_range']=[8.75,8.84]     
                    if plot_settings[key_plot]['col_in']=='none':plot_settings[key_plot]['y_range']=[0.998,1.002] 
                    if plot_settings[key_plot]['norm_ref']:plot_settings[key_plot]['y_range']=[0.993,1.008] 
                    if gen_dic['trim_spec']:plot_settings[key_plot]['y_range'] = None
            ...
            if (plot_prop=='ctrst'):
                ...
                if gen_dic['star_name']=='55Cnc':    
                    if ('ESPRESSO' in data_dic['DI']) and (gen_dic['n_instru']==1) and plot_settings[key_plot]['norm_ref']:
                ...
                if gen_dic['star_name']=='HD209458':
                    if plot_settings[key_plot]['col_in']=='none':plot_settings[key_plot]['y_range']=[0.9985,1.0015]    
                if gen_dic['star_name']=='WASP76':
                    plot_settings[key_plot]['y_range']=[0.5715,0.5745]     
                    if plot_settings[key_plot]['col_in']=='none':plot_settings[key_plot]['y_range']=[0.997,1.003] 
                    if plot_settings[key_plot]['norm_ref']:plot_settings[key_plot]['y_range']=[0.995,1.005] 
                    if gen_dic['trim_spec']:plot_settings[key_plot]['y_range'] = None
    ...
    if (plot_dic['input_LC']!=''):
        ...
        plot_settings[key_plot]['achrom']=True
...
#                'HARPS':['31-12-17'], 
        ...
        #     plot_settings[key_plot]['x_range']=[-0.16,0.19]   
            ...
            plot_settings[key_plot]['x_range']=[-0.015,0.015]  
            plot_settings[key_plot]['y_range']=[0.972,1.002] 
        elif gen_dic['star_name']=='HD89345':  
            plot_settings[key_plot]['x_range']=[-0.012,0.017]  
        elif gen_dic['star_name']=='HD189733':  
            plot_settings[key_plot]['x_range']=[-0.042,0.053]  
...
#            plot_settings[key_plot]['x_range']=[6200.,6300.] 
    ...
    #        plot_settings[key_plot]['visits_to_plot']={'HARPS':['31-12-17']}     
        ...
        #Shade area not included in fit
        plot_settings[key_plot]['shade_unfit']=True    & False
    ...
    if (plot_dic['map_Intr_prof']!=''):
        ...
        # if gen_dic['star_name']=='HD209458':
            # plot_settings[key_plot]['margins']=[0.15,0.3,0.85,0.9]   #ANTARESS I, mock, multi-tr   
        ...
        #    - if not aligned 
        #    - based on properties given in settings
        plot_settings[key_plot]['theoRV_HR']=True #  &   False
        ...
        if gen_dic['star_name']=='WASP76':
            ...
            v_range_comm = [0.35,1.07]   #ANTARESS I CCFS intr
            plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20190720':v_range_comm,'20190911':v_range_comm}}
            plot_settings[key_plot]['sc_fact10']=0
        elif gen_dic['star_name']=='HD189733': 
            v_range_comm = [0.35,1.07]   #ANTARESS I CCFS intr
            v_range_comm = [0.35,1.1]   #ANTARESS I CCFS intr
            plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':v_range_comm,'20210830':v_range_comm}}
            plot_settings[key_plot]['sc_fact10']=0
        ...
        if gen_dic['star_name']=='HAT_P3':
            ...
            plot_settings[key_plot]['v_range_all']['HARPS']={'mock_vis':[0.6,1.4]}                
            # plot_settings[key_plot]['v_range_all']['HARPS']={'mock_vis':None}  
        elif gen_dic['star_name']=='WASP69':
            v_range_comm = [0.3,1.1]
            plot_settings[key_plot]['v_range_all']['HARPN']={'20160604':v_range_comm,'20160804':v_range_comm}
            v_range_comm = [0.3,1.1]
            plot_settings[key_plot]['v_range_all']['HARPS']={'20120621':v_range_comm,'20230624':v_range_comm,'20230729':v_range_comm,'20230825':v_range_comm}
            v_range_comm = [0.7,1.1]
            plot_settings[key_plot]['v_range_all']['NIRPS_HE']={'20230624':v_range_comm,'20230729':v_range_comm,'20230825':v_range_comm}             
        ...
        if gen_dic['star_name']=='WASP76':
            ...
            # plot_settings[key_plot]['x_range']=[-150,150]
            plot_settings[key_plot]['x_range']=[-90.,90]   #ANTARESS I
            ...
            plot_settings[key_plot]['x_range']= [5893.-6.1  ,5893.+6.1 ]   #Na doublet
            # plot_settings[key_plot]['x_range']= [-90.,90. ]   #CCF white
            y_range_comm = [-0.019  , 0.019] 
            plot_settings[key_plot]['y_range_all']={'ESPRESSO':{'20190720':y_range_comm,'20190911':y_range_comm}} 
        elif gen_dic['star_name']=='HD189733':
            plot_settings[key_plot]['x_range']= [-51.,51. ]  
            y_range_comm = [-0.018  , 0.018] 
            plot_settings[key_plot]['y_range_all']={'ESPRESSO':{'20210810':y_range_comm,'20210830':y_range_comm}} 
        elif gen_dic['star_name']=='WASP69':
            y_range_comm = [-0.014  , 0.014] 
            plot_settings[key_plot]['y_range_all']['HARPN']={'20160604':y_range_comm,'20160804':y_range_comm}
            plot_settings[key_plot]['y_range_all']['HARPS']={'20120621':y_range_comm,'20230624':y_range_comm,'20230729':y_range_comm,'20230825':y_range_comm}
            plot_settings[key_plot]['y_range_all']['NIRPS_HE']={'20230624':y_range_comm,'20230729':y_range_comm,'20230825':y_range_comm}             
        ...
        if gen_dic['star_name']=='HAT_P3':
            ...
            plot_settings[key_plot]['x_range']= [-41.,41.]     #zoom 
            y_range_comm = [-0.017,0.017]
            plot_settings[key_plot]['y_range_all']={'CARMENES_VIS':{'20190928':y_range_comm,'20191025':y_range_comm,'20191210':y_range_comm}}
        elif gen_dic['star_name']=='WASP43':
    ...
    if (plot_dic['map_Intrbin']!=''):
        ...
        #RM survey
            ...
            plot_settings[key_plot]['v_range_all']={'HARPN':{'binned':[0.3,1.1]}}  
        ...
        #RM survey
            ...
            plot_settings[key_plot]['x_range']=[-80.,80.]  
            plot_settings[key_plot]['y_range_all']={'HARPN':{'binned':[-0.013,0.013]}}             
    ...
    if (plot_dic['map_Intr_1D']!=''):
        ...
        #Normalize profiles
        plot_settings[key_plot]['norm_prof']=True  & False
        ...
        #Shade areas
        if gen_dic['star_name']=='HD209458':
            plot_settings[key_plot]['shade_ranges']= glob_fit_dic['IntrProf']['fit_range']  
    ...
    if (plot_dic['map_Intr_prof_est']!='') or (plot_dic['map_Intr_prof_res']!=''):
        for key_plot in ['map_Intr_prof_est','map_Intr_prof_res']:
            if plot_dic[key_plot]!='':
                ...
                #Model type
                #    - model from best-fit ('fit') or reconstruction ('rec')
                plot_settings[key_plot]['line_model']='rec'

                #Choose mode to retrieve for reconstructed profile
                ...
                #Stellar lines in spectral mode
                plot_settings[key_plot]['st_lines_wav'] = [5889.95094,5892.88000,5895.92424]                
                
                #Overplot RV(pl/star) model 
                if gen_dic['star_name']=='HAT_P49':plot_settings[key_plot]['theoRVpl_HR']=True  
                # if gen_dic['star_name']=='HD189733':plot_settings[key_plot]['theoRVpl_HR']=True  

                #Planet lines in spectral mode
                plot_settings[key_plot]['pl_lines_wav'] = [5889.95094,5892.88000,5895.92424]
                ...
                #RM survey
                    ...
                    plot_settings[key_plot]['x_range']=[-90.,90]      #white CCFs
                    plot_settings[key_plot]['x_range']= [5893.-6.1  ,5893.+6.1 ]   #Na doublet
                    ...
                    plot_settings[key_plot]['x_range']=[5883.,5902.]
                    plot_settings[key_plot]['x_range']=[-90.,90]   #ANTARESS I 
                    plot_settings[key_plot]['y_range_all']={'ESPRESSO':{'20180902':[-0.07,0.09],'20181030':[-0.077,0.087]}} 
                elif gen_dic['star_name']=='WASP69':      
                    plot_settings[key_plot]['x_range']=[-80.,80] 
                    y_range_comm = [-0.014  , 0.014]   #transit
                    plot_settings[key_plot]['y_range_all']['NIRPS_HE']={'20230624':y_range_comm,'20230729':y_range_comm,'20230825':y_range_comm}
                    plot_settings[key_plot]['y_range_all']['NIRPS_HE']={'20230624':[-0.0235  , 0.021] ,'20230729':[-0.019  , 0.033],'20230825':[-0.023  , 0.025] }  

                if gen_dic['star_name']=='HD189733':
                    #plot_settings[key_plot]['x_range']=[37.,41.]
                    plot_settings[key_plot]['x_range']=[37.5,47.]
                    #plot_settings[key_plot]['x_range']=[41.,45.]
                    #plot_settings[key_plot]['x_range']=[45.,49.]
                    #plot_settings[key_plot]['x_range']=[45,50]
                    # plot_settings[key_plot]['x_range']=[49.,53.]
                    #plot_settings[key_plot]['x_range']=[50,56]
                    #plot_settings[key_plot]['x_range']=[53.,57.]
                    #plot_settings[key_plot]['x_range']=[54.5,58.5]
                    #plot_settings[key_plot]['x_range']=[57.,61.]
                    #plot_settings[key_plot]['x_range']=[59.,63.]
                    #plot_settings[key_plot]['x_range']=[61.,65.]
                    #plot_settings[key_plot]['x_range']=[63.,67.]
                    #plot_settings[key_plot]['x_range']=[65.,69.]
                    #plot_settings[key_plot]['x_range']=[69.,73.]
                    
                    # plot_settings[key_plot]['x_range']=[44,55]
                    #plot_settings[key_plot]['x_range']=[55,73]   
                    
                    plot_settings[key_plot]['x_range']=[5887.,5899.] 
                    
                    # plot_settings[key_plot]['x_range']=[5889.,5897.] 
                    # plot_settings[key_plot]['y_range_all']['ESPRESSO']={'20210810':[-0.018  , 0.018] ,'20210830':[-0.018  , 0.018] }  
                    
                    # plot_settings[key_plot]['x_range']=[3000.,9000.] 
                    plot_settings[key_plot]['x_range']=[-51.,51.] 
                ...
                if key_plot=='map_Intr_prof_est':
                    ...
                    #RM survey                
                        ...
                        y_range_comm = [-0.019  , 0.019]            #in-transit
                        plot_settings[key_plot]['y_range_all']={'ESPRESSO':{'20190720':y_range_comm,'20190911':y_range_comm}}                     
                        ...
                        plot_settings[key_plot]['v_range_all']['NIRPS_HE']={'20230624':[0.75,1.1],'20230729':[0.75,1.1],'20230825':[0.75,1.1]} 
                    elif gen_dic['star_name']=='HD189733': 
                        v_range_comm = [0.35,1.1]   #ANTARESS I CCFS intr
                        plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':v_range_comm,'20210830':v_range_comm}}                       
                        y_range_comm = [-0.018  , 0.018] 
                ...
                if key_plot=='map_Intr_prof_res':
                    ...
                    #Account for spectral continuum profile
                    #    - set to DI or Intr (corresponding continuum must have been calculated)
                    plot_settings[key_plot]['st_cont'] = 'Intr'
        
                    #Color range 
                    if gen_dic['star_name']=='WASP76':
                        v_range_comm=[-2.2e-2,2.2e-2]
                        plot_settings[key_plot]['sc_fact10']=2.
                        plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20180902':v_range_comm,'20181030':v_range_comm}}        
                    elif gen_dic['star_name']=='HD209458':

                        plot_settings[key_plot]['y_range_all']['ESPRESSO']={'20190720':[-0.0295 , 0.04],'20190911':[-0.0305,0.0375]}    #full visits           
                        
                        plot_settings[key_plot]['sc_fact10']=2.
                        v_range_comm=[-1e-2,1e-2]    #white CCFs
                        v_range_comm=[-1.5e-2,1.5e-2]           #Na doublet                       
                        plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20190720':v_range_comm,'20190911':v_range_comm}} 
                    ...
                    if gen_dic['star_name']=='HAT_P3':
                        ...
                        plot_settings[key_plot]['sc_fact10']=3.
                        yrange_comm = [-5e-3,5e-3]
                        plot_settings[key_plot]['v_range_all']['NIRPS_HE']={'20230624':yrange_comm,'20230729':yrange_comm,'20230825':yrange_comm}                         

                    elif gen_dic['star_name']=='HD189733':
                        plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':[-0.007,0.007],'20210830':[-0.005,0.005]}}
                        #plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':[-0.005,0.005],'20210830':[-0.003,0.003]}}
                        #plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':[-0.008,0.008],'20210830':[-0.003,0.003]}}
                        #plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':[-0.004,0.004],'20210830':[-0.002,0.002]}}  
                        # plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':[-0.02,0.02],'20210830':[-0.01,0.01]}}   
                        plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':[-0.045,0.01],'20210830':[-0.045,0.01]}}   #Na  
                        # plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':[-0.04,0.0],'20210830':[-0.04,0.0]}}   #Na in-tr                   


                        v_range_comm = [-0.025,0.025]   #ANTARESS I CCFS intr
                        plot_settings[key_plot]['v_range_all']={'ESPRESSO':{'20210810':v_range_comm,'20210830':v_range_comm}}                       
                        plot_settings[key_plot]['y_range_all']={'ESPRESSO':{'20210810':[-0.0405  , 0.036] ,'20210830':[-0.032  , 0.0515] }}
                        plot_settings[key_plot]['sc_fact10']=2
...
#             # x_range=None
    ...
    if ((plot_dic['Intr_prof']!='') or (plot_dic['Intr_prof_res']!='')):
        for key_plot in ['Intr_prof','Intr_prof_res']:
            if plot_dic[key_plot]!='':
                ...
                #Plot errors
                plot_settings[key_plot]['plot_err'] = True   #& False   
                plot_settings[key_plot]['alpha_err'] = 0.3
                ...
                #Scaling factor (in power of ten, ie flux are multiplied by 10**sc_fact10)
                plot_settings[key_plot]['sc_fact10']=0.  #-3.
            ...
            #        plot_settings[key_plot]['visits_to_plot']={'HARPS':['31-12-17']}     
                ...
                # elif gen_dic['star_name']=='HD209458':
                #     # plot_settings[key_plot]['color_dic']={'ESPRESSO':{'20190911':'dodgerblue'}}   #ANTARESS I, CCF intr
                #     # plot_settings[key_plot]['color_dic']={'ESPRESSO':{'20190911':'limegreen'}}   #ANTARESS I, CCF intr
                #     # plot_settings[key_plot]['hide_axis'] = True
                #     plot_settings[key_plot]['color_dic']={'ESPRESSO':{'20190911':'red'}}   #ANTARESS I, CCF intr
                #     plot_settings[key_plot]['hide_axis'] = True                
        ...
        #            plot_settings[key_plot]['x_range']=[6200.,6300.] 
                ...
                elif gen_dic['star_name']=='WASP69':plot_settings[key_plot]['x_range']=[-100.,100]                  
            ...
            #            plot_settings[key_plot]['y_range']=[0.35,1.05]         
                        ...
                        # plot_settings[key_plot]['y_range']=[0.2,1.2]   #ANTARESS I CCF
                        # plot_settings[key_plot]['y_range']=[0.3,1.15]   #ANTARESS I CCF intr
                    ...
                    if gen_dic['star_name']=='Kepler68':plot_settings[key_plot]['y_range']=[-8.,8.]  
                        ...
                        plot_settings[key_plot]['y_range']=[0.1,1.25]    #HARPN, HARPS      
                        # plot_settings[key_plot]['y_range']=[0.55,1.3]    #NIRPS                
    ...
    if any('spec' in s for s in data_dic['Res']['type'].values()) and (plot_dic['sp_Intrbin']!=''):
        ...
        #Do not plot original data
        #    - useful to show only binned date
        if gen_dic['star_name']=='HD209458':plot_settings[key_plot]['no_orig']=True 

        #Normalize spectra to integrated flux unity
        #    - to allow for comparison
        if gen_dic['star_name']=='HD209458':plot_settings[key_plot]['norm_prof']=True        #ANTARESS I, Na
        ...
        #Na line change
        if gen_dic['star_name']=='HD209458':
            plot_settings[key_plot]['resample'] = 0.05  
            plot_settings[key_plot]['color_dic']={'ESPRESSO':{'binned':'black'}}         #idx4, star limb
            # plot_settings[key_plot]['hide_axis'] = True  
            # plot_settings[key_plot]['color_dic']={'ESPRESSO':{'binned':'dodgerblue'}} 
            # plot_settings[key_plot]['color_dic']={'ESPRESSO':{'binned':'limegreen'}} 
            # plot_settings[key_plot]['color_dic']={'ESPRESSO':{'binned':'orange'}} 
            # plot_settings[key_plot]['color_dic']={'ESPRESSO':{'binned':'red'}}         #idx0, star center
        ...
        if gen_dic['star_name']=='WASP76':
            ...
            # plot_settings[key_plot]['x_range'] = None
        if gen_dic['star_name']=='HD209458':
            plot_settings[key_plot]['x_range']=[5888.5,5897.5]   #Na doublet
...
#            plot_settings[key_plot]['y_range']=[0.35,1.05] 
        if gen_dic['star_name']=='WASP76':
            ...
            plot_settings[key_plot]['y_range']=None 
        if gen_dic['star_name']=='HD209458':
            plot_settings[key_plot]['y_range']=[0.,1.4] 
        ...
        for key_plot in ['CCF_Intrbin','CCF_Intrbin_res']:
            if plot_dic[key_plot]!='':  
                ...
                if gen_dic['star_name']=='HD3167':
                    ...
                    plot_settings[key_plot]['x_range']=[-51.,51.] 
                elif gen_dic['star_name']=='HD209458':plot_settings[key_plot]['visits_to_plot']={'ESPRESSO':['binned']} 
                ...
                if gen_dic['star_name']=='WASP107':plot_settings[key_plot]['color_dic']['HARPS']={'binned':'purple'} 
                    ...
                    plot_settings[key_plot]['color_dic']={'ESPRESSO':{'binned':'dodgerblue'}}   #ANTARESS I, resampling, low rproj binning

                    plot_settings[key_plot]['color_dic']={'ESPRESSO':{'binned':'red'}}   #ANTARESS I, resampling, high rproj binning
                    plot_settings[key_plot]['hide_axis'] = True
    ...
    if (any('spec' in s for s in data_dic['Intr']['type'].values())) and ((plot_dic['sp_Intr_1D']!='') or (plot_dic['sp_Intr_1D_res']!='')):
        for key_plot in ['sp_Intr_1D','sp_Intr_1D_res']:
            if plot_dic[key_plot]!='':
                ...
                plot_settings[key_plot]['font_size']=19         
                ...
                if gen_dic['star_name']=='HD209458':
                    plot_settings[key_plot]['iexp_plot']={'ESPRESSO':{
                        '20190720':[7,23,39],     #phase -0.01261 (iexp 21 i_in 7) ; -0.00019 (iexp 37 i_in 23) ; 0.01225 (iexp 53 i_in 39) ; 
                        '20190911':[7,23,39]}}     #phase -0.01196 (iexp 22 i_in 8) ; -0.00027 (iexp 37 i_in 23) ; 0.01217 (iexp 53 i_in 39) ;
                    plot_settings[key_plot]['iexp_plot']={'ESPRESSO':{
                        '20190720':[23],     #phase -0.01261 (iexp 21 i_in 7) ; -0.00019 (iexp 37 i_in 23) ; 0.01225 (iexp 53 i_in 39) ; 
                        '20190911':[23]}}     #phase -0.01196 (iexp 22 i_in 8) ; -0.00027 (iexp 37 i_in 23) ; 0.01217 (iexp 53 i_in 39) ;

        
                #Plot all exposures on the same plot
                # if gen_dic['star_name']=='HD209458':
                #     plot_settings[key_plot]['multi_exp']=True       
                #     plot_settings[key_plot]['color_dic']={'ESPRESSO':{'20190720':'rainbow','20190911':'rainbow'}} 
                #     plot_settings[key_plot]['color_dic_sec']={'ESPRESSO':{'20190720':'rainbow','20190911':'rainbow'}} 
                ...
                if gen_dic['star_name'] in ['HD209458','WASP76']:         
                    ...
                    plot_settings[key_plot]['resample'] = 0.08   #Zoom Na doublet
                    # plot_settings[key_plot]['resample'] = None   #Zoom NaIDI models
                    plot_settings[key_plot]['alpha_symb'] = 0.3
                    # plot_settings[key_plot]['no_orig']=True 
                ...
                if gen_dic['star_name']=='HD209458':
                    plot_settings[key_plot]['x_range']=[5893.-6.1  ,5893.+6.1 ] 
                    plot_settings[key_plot]['x_range']=[5884.,5902.]      #like DI profile
                    # plot_settings[key_plot]['x_range']=[5893.5,5898.5]      #NaIDI  models                           

                #Overrplot line model
                ...
                plot_settings[key_plot]['fitted_exp'] = True  & False
                ...
                if (key_plot=='sp_Intr_1D'):
                    ...
                    #Margins
                    plot_settings[key_plot]['margins']=[0.15,0.15,0.95,0.7]                       
                    ...
                    if gen_dic['star_name']=='HD209458':
                        plot_settings[key_plot]['y_range']=[-0.5,2.]     
                        plot_settings[key_plot]['y_range']=[-0.1,1.8]   
                        # plot_settings[key_plot]['y_range']=[0.,1.05]  #NaIDI  models      
                ...
                if (key_plot=='sp_Intr_1D_res'):
                    ...
                    #Margins
                    plot_settings[key_plot]['margins']=[0.15,0.15,0.95,0.6]                     

                    #Plot boundaries in signal   
                    if gen_dic['star_name']=='HD209458':
                        plot_settings[key_plot]['y_range']=[-0.9,0.9]   #Na doublet     
    ...
    if (plot_dic['plocc_ranges']!=''):
        ...
        if gen_dic['star_name']=='HD209458':
           if plot_settings[key_plot]['x_prop']=='r_proj':plot_settings[key_plot]['x_range']=[0.45,1.02]
    ...
    if (plot_dic['prop_DI_mcmc_PDFs']!='') or (plot_dic['prop_Intr_mcmc_PDFs']!=''):
        for key_plot in ['prop_DI_mcmc_PDFs','prop_Intr_mcmc_PDFs']:
            if plot_dic[key_plot]!='':
                ...
                #Fontsize
                plot_settings[key_plot]['font_size'] = 8                
                ...
                if gen_dic['star_name']=='WASP76':  
                    plot_settings[key_plot]['fig_size']=(16,10.)
                    plot_settings[key_plot]['margins']=[0.02,0.15,0.98,0.98] 
                if gen_dic['star_name']=='HD209458':  
                    plot_settings[key_plot]['fig_size']=(16,10.)
                    plot_settings[key_plot]['margins']=[0.02,0.15,0.98,0.98] 
                ...
                #    - 'rv', 'FWHM', 'ctrst', 'true_amp', 'true_ctrst', 'true_FWHM', 'a_damp'
                plot_settings[key_plot]['plot_prop_list']=['rv','ctrst','FWHM']
                # plot_settings[key_plot]['plot_prop_list']+=['a_damp']
                ...
                if gen_dic['star_name']=='HAT_P3':plot_settings[key_plot]['iexp_plot']={'HARPN':{'20200130':range(1,8)}}  
                    ...
                    plot_settings[key_plot]['iexp_plot']={'HARPS':{'20170309':range(3,44),'20170330':range(1,46),'20180323':range(1,27)}} 
                elif gen_dic['star_name']=='HD209458':
                    #White CCFs
                    ...
                    plot_settings[key_plot]['iexp_plot']={'ESPRESSO':{'20180902':list(np.delete(np.arange(21),[0,10,11,12,13,20])),'20181030':list(np.delete(np.arange(38),[0,1,18,19,20,21,22,23,24,25,37]))}} 
                elif gen_dic['star_name']=='WASP69':
                    plot_settings[key_plot]['iexp_plot']={
                        
                        #20230624: 0,13 hors-tr + limbs; 1 pas detectee, outlier en FWHM et RV; 2, 6,7 ont des systematiques dans le continu mais RVs semblent ok donc je les garde
                        #20230729: 0,25 hors-tr + limbs; 1,2, 24 pas detectees; 21 outlier en FWHM avec shape bizarre, 22 outlier en RV, 23 outlier en C avec shape bizarre
                        #20230825: 0,24 hors-tr; 1, 2, 23 pas detectees; 3 outlier en rv et pas vraiment detectee                                                                 
                        'NIRPS_HE':{'20230624':list(np.delete(np.arange(14),[0,1,13])),'20230729':list(np.delete(np.arange(26),[0,1,2,21,22,23,24,25])),'20230825':list(np.delete(np.arange(25),[0,1,2,3,23,24]))}, 
                        
                        #20160604: 8 hors-tr
                        #20160804: 0,9 hors-tr 
                        'HARPN':{'20160604':list(np.delete(np.arange(9),[8])),'20160804':list(np.delete(np.arange(10),[0,9]))}, 

                        #20120621: 0,21 hors-tr + limbs; 1 peu contraignante et semble un peu outlier; 2 outlier et detection marginale; 20 pas detectee
                        #20230624: 0,13 hors-tr + limbs; 12 semble outlier et detection marginale
                        #20230729: 0,1,22,23 pas detectees 
                        #20230825: 0,23 pas detectees 
                        'HARPS':{'20120621':list(np.delete(np.arange(22),[0,1,2,20,21])),'20230624':list(np.delete(np.arange(14),[0,12,13])),'20230729':list(np.delete(np.arange(24),[0,1,22,23])),'20230825':list(np.delete(np.arange(24),[0,1,22,23]))}} 
                ...
                elif gen_dic['star_name'] in ['HAT_P3','Kepler25','Kepler68','HAT_P33','K2_105','HD89345','WASP107','WASP166','HAT_P11','WASP156','HD106315','Kepler63','HIP41378','WASP47','HD209458','WASP76','WASP69']:
                ...
                elif gen_dic['star_name'] in ['WASP76']:plot_settings[key_plot]['nsub_col']=6
                ...
                # if gen_dic['star_name']=='WASP69':
                #     plot_settings[key_plot]['hspace'] = 0.2  
                ...
                if any(x in gen_dic['studied_pl'] for x in ['HD3167_c','HD3167_b']):   
                    plot_settings[key_plot]['x_range_all']={'rv': [-5,5],
                                'ctrst': [-1.99,1.99],  #[0.,0.99]
                                'FWHM': [0.,19.99]}
                if gen_dic['studied_pl']==['TOI858b']:
                    plot_settings[key_plot]['x_range_all']={'rv': [-2.,8.],
                                'FWHM': [0.,16.],
                                'ctrst': [-0.5,2.]}
                if gen_dic['studied_pl']==['GJ436_b']:
                    plot_settings[key_plot]['x_range_all']={'rv': [-0.99,0.99],
                                'FWHM':[0.,10.],
                                # 'FWHM':[2.,7.]   #paper, ESP
                    ...
                    plot_settings[key_plot]['x_range_all']['true_FWHM'] = plot_settings[key_plot]['x_range_all']['FWHM']
                    plot_settings[key_plot]['x_range_all']['true_ctrst'] = plot_settings[key_plot]['x_range_all']['ctrst']
                if gen_dic['star_name']=='WASP76':
                    plot_settings[key_plot]['x_range_all']={'rv': [-3.,3.],'FWHM':[5.,14.],'ctrst':[0.3,0.9]}                  
                    plot_settings[key_plot]['x_range_all']={'rv': [-1.5,1.5],'FWHM':[6.,13.],'ctrst':[0.4,0.75]}   
                    plot_settings[key_plot]['y_range'] = None
                if gen_dic['star_name']=='HD209458':
                    plot_settings[key_plot]['y_range'] = None
                    
                    #White CCFs
                    plot_settings[key_plot]['x_range_all']={'rv': [-7.,7.],'FWHM':[5.,10.],'ctrst':[0.4,0.9]}                  

                    # #CCF Na
                    # plot_settings[key_plot]['x_range_all']={'rv': [-10.,10.],'FWHM':[0.,30.],'ctrst':[0.,1.]}   
                if gen_dic['star_name']=='WASP69':
                    plot_settings[key_plot]['x_range_all']={'rv': [-4.,4.],'FWHM':[2.,15.],'ctrst':[0.,1.]}  
...
#            plot_settings[key_plot]['color_dic']={'2018-10-31':'dodgerblue','2018-09-03':'red'}  
    ...
    if (plot_dic['prop_Intr']!=''):
        ...
        plot_settings['prop_Intr_ordin']=['rv','rv_res','FWHM_voigt','ctrst']      
        ...
        for plot_prop in plot_settings['prop_Intr_ordin']:
            ...
            plot_settings[key_plot]['margins']=[0.15,0.12,0.95,0.6]    #elongated

            #Font size
            plot_settings[key_plot]['font_size']=18

            #Choose bin dimension
            #    - for properties derived from binned data
            #    - 'phase', 'xp_abs', 'r_proj' (see details and routine)
            plot_settings[key_plot]['dim_plot']='r_proj'   
            plot_settings[key_plot]['dim_plot']='phase'  
            ...
            plot_settings[key_plot]['prop_Intr_absc']='phase'
            # plot_settings[key_plot]['prop_Intr_absc']='r_proj'
        ...
        #            'HARPS':['14-01-18','09-01-18','31-12-17'],
            ...
            #     plot_settings[key_plot]['visits_to_plot']={'CORALIE':['20210118']}         
                ...
                # plot_settings[key_plot]['visits_to_plot']={'HARPS':['20120621']}
                # plot_settings[key_plot]['visits_to_plot']={'HARPS':['20230624']}
                # plot_settings[key_plot]['visits_to_plot']={'HARPS':['20230729']}
                # plot_settings[key_plot]['visits_to_plot']={'HARPS':['20230825']}
                plot_settings[key_plot]['visits_to_plot']={'HARPS':['20120621','20230624','20230729','20230825']}
                # plot_settings[key_plot]['visits_to_plot']={'HARPN':['20160604']}
                # plot_settings[key_plot]['visits_to_plot']={'HARPN':['20160804']}                
                plot_settings[key_plot]['visits_to_plot'].update({'HARPN':['20160604','20160804']})                  
                # plot_settings[key_plot]['visits_to_plot']={'NIRPS_HE':['20230624']}
                # plot_settings[key_plot]['visits_to_plot']={'NIRPS_HE':['20230729']}
                # plot_settings[key_plot]['visits_to_plot']={'NIRPS_HE':['20230825']}
                plot_settings[key_plot]['visits_to_plot'].update({'NIRPS_HE':['20230624','20230729','20230825']})               
        ...
        #                    'binned':{'HARPS-binned':[15,30,31],'HARPS-binned-2018':[]}}  
            ...
            elif gen_dic['star_name']=='WASP69':   #See selection in 'plot_dic['prop_Intr_mcmc_PDFs']'
                plot_settings[key_plot]['idx_noplot']={
                    'NIRPS_HE':{'20230624':[0,1,13],'20230729':[0,1,2,21,22,23,24,25],'20230825':[0,1,2,3,23,24]},
                    'HARPN':{'20160604':[8],'20160804':[0,9]}, 
                    'HARPS':{'20120621':[0,1,2,20,21],'20230624':[0,12,13],'20230729':[0,1,22,23],'20230825':[0,1,22,23]}, 
                    } 
            elif gen_dic['star_name']=='HD189733':
                plot_settings[key_plot]['idx_noplot']={'ESPRESSO':{'20210810':[0],'20210830':[0]}}  
                plot_settings[key_plot]['idx_noplot']={'ESPRESSO':{'20210810':[0],'20210830':[0,3,4,5,6]}}   #no spot
            ...
            #Plot HDI subintervals, if available
            plot_settings[key_plot]['plot_HDI']=True  # & False    
            if plot_settings[key_plot]['plot_HDI']:
                ...
                #RM survey
                    ...
                    plot_settings[key_plot]['nwalkers'] = 100
                    plot_settings[key_plot]['nsteps'] = 1500
                elif gen_dic['star_name'] in ['HAT_P3','Kepler_25','Kepler_68','HAT_P33','K2_105','HD89345','WASP107','WASP166','HAT_P11','WASP156','HIP41378','HD209458','WASP76','WASP69']:
                    plot_settings[key_plot]['nwalkers'] = 50
                    plot_settings[key_plot]['nsteps'] = 1000
                    plot_settings[key_plot]['plot_err'] = False
            ...
            #RM survey
                ...
                plot_settings[key_plot]['color_dic']={
                    'NIRPS_HE':{'20230624':'dodgerblue','20230729':'limegreen','20230825':'red'},
                    'HARPS':{'20120621':'dodgerblue','20230624':'limegreen','20230729':'magenta','20230825':'red'},
                    'HARPN':{'20160604':'dodgerblue','20160804':'red'}
                    }          
            ...
            plot_settings[key_plot]['bin_val'] = {}
            if 1==0:
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':
                    dbin,bin_min,bin_max=0.01 ,-0.15  ,0.18
                    if gen_dic['star_name']=='HAT_P11': 
                        dbin,bin_min,bin_max=0.0015 ,-0.01  ,0.01
                    elif gen_dic['star_name']=='HD209458': 
                        plot_settings[key_plot]['bin_val']['ESPRESSO']= {'dbin':(0.0161+0.0164)/41.,'bin_min':-0.0164,'bin_max':0.0161,'color':'black'}   
                    elif gen_dic['star_name']=='WASP69': 
                        plot_settings[key_plot]['bin_val']['NIRPS_HE']= {'dbin':0.002,'bin_min':-0.009,'bin_max':0.01,'color':'black'} 
                elif plot_settings[key_plot]['prop_Intr_absc']=='r_proj':
            ...
            #Apply instrumental convolution with relevant properties
            #    - this may be useful to compare the best fit intrinsic line properties derived from the joint profile fit with properties derived from fit to individual profiles
            #      in that case it is however more direct to convolve the model of individual profiles, so that the derived properties are also directly intrinsic
            plot_settings[key_plot]['inst_conv'] = False
            ...
            if gen_dic['star_name']=='HD3167': 
                if plot_settings[key_plot]['prop_Intr_absc'] in ['abs_y_st','y_st2']:
                    plot_settings[key_plot]['x_range']=[0.,1.]    
                    plot_settings[key_plot]['x_range']=[-0.02,0.75]    #paper
                if plot_settings[key_plot]['prop_Intr_absc']=='abs_lat':plot_settings[key_plot]['x_range']=[0.,180.]  
                if plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[-0.02,0.92]  
                    
                if gen_dic['studied_pl']==['HD3167_c']:
                    if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.004,0.004]     
                    if plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[0.05,0.9]     
                    if plot_settings[key_plot]['prop_Intr_absc']=='y_st':plot_settings[key_plot]['x_range']=[-1.,1.]
                    if plot_settings[key_plot]['prop_Intr_absc']=='lat':plot_settings[key_plot]['x_range']=[-180.,180.]  
                if gen_dic['studied_pl']==['HD3167_b']:
                    if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.04,0.04]    
                    if plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[-0.02,0.92]              
                    if plot_settings[key_plot]['prop_Intr_absc']=='xp_abs':plot_settings[key_plot]['x_range']=[0.,0.9]  
                    if plot_settings[key_plot]['prop_Intr_absc']=='r_proj':plot_settings[key_plot]['x_range']=[0.2,1.]      
                    if plot_settings[key_plot]['prop_Intr_absc']=='y_st':plot_settings[key_plot]['x_range']=[-1.,1.]
                    if plot_settings[key_plot]['prop_Intr_absc']=='lat':plot_settings[key_plot]['x_range']=[-180.,180.]
            ...
            if gen_dic['star_name']=='GJ436':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.0085,0.0085]              
                if plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[0.2,0.505]     
                    ...
                    if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.045,0.045] 
                    if plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[0.,1.]                
                    if plot_settings[key_plot]['prop_Intr_absc']=='y_st':plot_settings[key_plot]['x_range']=[-1.,1.]                    
                    if plot_settings[key_plot]['prop_Intr_absc']=='y_st2':plot_settings[key_plot]['x_range']=[0.,1.]                    
                    if plot_settings[key_plot]['prop_Intr_absc']=='lat':plot_settings[key_plot]['x_range']=[-180.,180.]  
            elif gen_dic['star_name']=='HD209458':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.0185,0.0185]     #phase  
            elif gen_dic['star_name']=='WASP76':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.047,0.047]     #phase     
            elif gen_dic['star_name']=='HD189733':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.0175,0.0175]     #phase 
    
            #RM survey
            elif gen_dic['star_name']=='HAT_P3':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.016,0.016]   
                elif plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[0.2,0.8]   
            elif gen_dic['star_name']=='HAT_P33':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.029,0.029]  
                elif plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[0.3,1.]                     
            elif gen_dic['star_name']=='HAT_P49':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.035,0.035]         
            elif gen_dic['star_name']=='WASP107':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.011,0.011]  
                elif plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[0.2,1.]
                elif plot_settings[key_plot]['prop_Intr_absc']=='r_proj':plot_settings[key_plot]['x_range']=[0.15,0.99]
            elif gen_dic['star_name']=='WASP166':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.0145,0.0145]   
                elif plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[0.,1.]       
            elif gen_dic['star_name']=='HAT_P11':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.012,0.012]  
                elif plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[0.2,1.]           
            elif gen_dic['star_name']=='WASP156':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.013,0.013]  
                elif plot_settings[key_plot]['prop_Intr_absc']=='mu':plot_settings[key_plot]['x_range']=[0.,1.]   
            elif gen_dic['star_name']=='HD106315':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.0045,0.0045] 
            elif gen_dic['star_name']=='WASP69':
                if plot_settings[key_plot]['prop_Intr_absc']=='phase':plot_settings[key_plot]['x_range']=[-0.0123,0.0123] 
            ...
            if gen_dic['studied_pl']==['TOI858b']:
                ...
                # plot_settings[key_plot]['IntrProf_path']='/Users/bourrier/Travaux/ANTARESS/Ongoing/HD189733b_Saved_data/Joined_fits/IntrProf/'  
                # plot_settings[key_plot]['IntrProf_path']='/Users/bourrier/Travaux/ANTARESS/Ongoing/HD189733b_Saved_data/Joined_fits/IntrProf/mcmc/'  
                
                #Final best-fit
                plot_settings[key_plot]['IntrProf_path']='/Users/bourrier/Travaux/ANTARESS/Ongoing/HD189733b_Saved_data/Joined_fits/IntrProf/mcmc_final/run_ij_final/Low_istar_FINAL/'


            elif gen_dic['star_name']=='WASP69':
                plot_settings[key_plot]['IntrProp_path']=None                   
                # plot_settings[key_plot]['IntrProp_path']='/Users/bourrier/Travaux/ANTARESS/Ongoing/WASP69b_Saved_data/Joined_fits/IntrProp/chi2/'  
                ...
                plot_settings[key_plot]['IntrProf_path']='/Users/bourrier/Travaux/ANTARESS/Ongoing/WASP69b_Saved_data/Joined_fits/IntrProf/NIRPS/Comm_mask/FINAL/'
                plot_settings[key_plot]['IntrProf_path']='/Users/bourrier/Travaux/ANTARESS/Ongoing/WASP69b_Saved_data/Joined_fits/IntrProf/HARPS/mcmc_b/'
                plot_settings[key_plot]['IntrProf_path']='/Users/bourrier/Travaux/ANTARESS/Ongoing/WASP69b_Saved_data/Joined_fits/IntrProf/HARPN/mcmc_b/'
                plot_settings[key_plot]['IntrProf_path']='/Users/bourrier/Travaux/ANTARESS/Ongoing/WASP69b_Saved_data/Joined_fits/IntrProf/mcmc/'
            ...
            if 1==0:
                plot_settings[key_plot]['deg_prop_fit']={}
                plot_settings[key_plot]['fit_sin']={}
                deg_corr = 0
                for inst in plot_settings[key_plot]['visits_to_plot']:
                    plot_settings[key_plot]['deg_prop_fit'][inst]={}
                    for vis in plot_settings[key_plot]['visits_to_plot'][inst]:plot_settings[key_plot]['deg_prop_fit'][inst][vis]={plot_settings[key_plot]['prop_Intr_absc']:deg_corr}
    
                if gen_dic['star_name']=='HD209458':
                    if (plot_prop in ['rv_res','FWHM','ctrst']):
                        plot_settings[key_plot]['deg_prop_fit']['ESPRESSO']['20190720']['phase']= 1   
                        plot_settings[key_plot]['deg_prop_fit']['ESPRESSO']['20190911']['phase']= 1  
                        plot_settings[key_plot]['fit_sin']['ESPRESSO']={'20190720':'phase','20190911':'phase'}
                   

            #Points to be fitted
            #    - set instrument and visit to an empty list for all plotted exposures to be fitted automatically, otherwise indicate specific exposures
            plot_settings[key_plot]['idx_fit']={} 
            if 'visits_to_plot' in plot_settings[key_plot]:                             
                for inst in plot_settings[key_plot]['visits_to_plot']:
                    plot_settings[key_plot]['idx_fit'][inst]={}
            ...
            if (plot_prop=='rv' ):
                ...
                #Model components to overplot
                #    - none (empty list), solid-body ('SB'), convective blueshift ('CB'), differential rotation ('DR')
                plot_settings[key_plot]['contrib_theo_HR'] = []   
                # if gen_dic['star_name'] == 'HD189733':plot_settings[key_plot]['contrib_theo_HR'] = ['SB','CB','DR']  
                ...
                # if gen_dic['star_name']=='HD189733':plot_settings[key_plot]['calc_envMCMC_theo_HR_nom'] = '/Users/bourrier/Travaux/ANTARESS/Ongoing/HD189733b_Saved_data/Joined_fits/IntrProf/mcmc/Sample_dics.npz'
        ...
        #            plot_settings[key_plot]['y_range']=[-3.,6.5]
                ...
                elif gen_dic['star_name']=='TOI4562':plot_settings[key_plot]['y_range']=[-20,20]      
                elif gen_dic['star_name']=='WASP69':
                    plot_settings[key_plot]['y_range']=[-2,2] 
                    plot_settings[key_plot]['y_range']=[-3,3] 
            ...
            if (plot_prop=='rv_res' ):
                ...
                #Model components to subtract
                #    - full model ('full', default) or solid-body (SB)
                # plot_settings[key_plot]['mod_compos'] = 'SB'             

                #Model components to overplot
                #    - none (empty list), convective blueshift ('CB'), differential rotation ('DR', which will be the difference between RV with and without DR), 'CB_DR' the sum of the two components
                # plot_settings[key_plot]['contrib_theo_HR'] = ['CB','DR','CB_DR']    
                ...
                #     plot_settings[key_plot]['y_range']=[-2000.,2000.]     #CCF Na
                    ...
                    plot_settings[key_plot]['y_range']=[-550.,550.]

                    plot_settings[key_plot]['y_range']=[-160.,160.]
                    plot_settings[key_plot]['margins']=[0.15,0.12,0.95,0.4]                    
            ...
            if (plot_prop=='FWHM' ):
                ...
                elif gen_dic['star_name']=='TOI4562':plot_settings[key_plot]['y_range']=[0,20] 
                elif gen_dic['star_name']=='WASP69':
                    plot_settings[key_plot]['y_range']=[3.,19.]     #HARPN
                    plot_settings[key_plot]['y_range']=[0.,17.]     #NIRPS            
            ...
            if (plot_prop=='ctrst' ):
                ...
                elif gen_dic['star_name']=='TOI4562':plot_settings[key_plot]['y_range']=[0.,1.] 
                elif gen_dic['star_name']=='WASP69':
                    plot_settings[key_plot]['y_range']=[0.3,1.]    #HARPN, HARPS
                    # plot_settings[key_plot]['y_range']=[0.,0.6]    #NIRPS
            ...
            if (plot_prop=='a_damp' ):
                ...
                # plot_settings[key_plot]['y_range']=[0.,0.6]
...
#             # plot_settings[key_plot]['x_range']=None
    ...
    if (plot_dic['system_view']!=''):
        ...
        #Orbit colors
        if 'pl_to_plot' in plot_settings[key_plot]:
        ...
        elif gen_dic['star_name']=='WASP76':plot_settings[key_plot]['norb']=500       
        ...
        if gen_dic['star_name']=='HD3167':
            ...
            plot_settings[key_plot]['aRs_err'] = {'WASP76b':[0.035,0.046]}   
            plot_settings[key_plot]['lambdeg_err'] = {'WASP76b':[2.2,1.9]}          
            plot_settings[key_plot]['ip_err'] = {'WASP76b':[0.015,0.026]}          
            plot_settings[key_plot]['b_range_all'] = {'WASP76b':[0.028-0.023,0.028+0.13]}    #aRscosi = 4.055*np.cos(89.6016*np.pi/180.) = 0.028 ok
    ...
    #    plot_settings[key_plot]['plot_colbar']=False #dezoom GJ436
        ...
        if gen_dic['star_name']=='WASP76':        
            plot_settings[key_plot]['xst_dir'] = [-0.5,-0.4]
...
# #            x_range=[6200.,6300.] 
    ...
    if ((plot_dic['Atm_prof']!='') or (plot_dic['Atm_prof_res']!='')):
        ...
        #                            'binned':['HARPS-binned-2018']}
                ...
                #---------------------------------
                #Residuals profiles
                if (plot_dic['Atm_prof_res']!='') and ((gen_dic['fit_Atm']) or (gen_dic['fit_AtmProf'])):     
                    key_plot='Atm_prof_res'  
    ...
    ##################################################################################################
    #%%% Individual binned atmospheric spectral profiles
    ##################################################################################################
