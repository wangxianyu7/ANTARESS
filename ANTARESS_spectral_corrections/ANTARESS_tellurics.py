...
def corr_tell(gen_dic,data_inst,inst,data_dic,data_prop,coord_dic,plot_dic):
    ...
    if (gen_dic['calc_corr_tell']):
        ...
        if gen_dic['calc_tell_mode']=='autom':
            ...
            #HITRAN properties
            static_model_path = 'ANTARESS_spectral_corrections/Telluric_processing/Static_model/'
            tell_mol_dic={}
...
def open_resolution_map(instrument,time_science,ins_mod,bin_x):
    ...
    """
    static_resol_path = 'ANTARESS_spectral_corrections/Telluric_processing/Static_resolution/'
